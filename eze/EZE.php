...
<head>
  ...
  <link rel="icon"  href="eze_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="eze_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">Mini_Project</a>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="2000">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <img src="eze_images/eze1.jpg" class="d-block  w-100" alt="Image 1">
          </div>
          <div class="carousel-item" data-bs-interval="1500">
            <img src="eze_images/eze2.jpg" class="d-block w-100" alt="Image 2">
          </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="para">Eze is a B2B Marketplace that connects telecommunication and global electronic wholesalers allowing them to trade devices in wholesale quantities with real-time market data. It aims to formalize the fragmented and inefficient second-hand electronics market that had an estimated beachhead of $46 billion.Minimum salary at Eze Software depends on the role you are applying for. For Associate Software Engineer the minimum salary is ₹7.2 Lakhs per year, for Engagement Specialist the minimum salary is ₹8.9 Lakhs per year and so on.</p>
...
<div class="row">
  <div class="col-md-10">
    <p class="para"> 
    The Eze story began 25 years ago with a vision that emerging technology could bring trading operations - and people - closer together. A lot has changed as we’ve grown into the technology leader we are today. However, this ideal has remained the same.<br>
      The EZE software recruitment process consists of three rounds of selection and includes:</p>
...
<div class="col-md-6 text-align-center">
     ...
     <div class="col-md-6">
      ...
      <img src="eze_images/apptitude.png" alt="" class="img-fluid"  id='recruitingimages'>
     </div>
...
<div class="row mt-2">
  <div class="col-md-6">
    <img src="eze_images/interview.png" alt="" class='img-fluid'  id='recruitingimages'>
  </div>
  <div class="col-md-6">
...
Most candidates tend to think that the HR interview is easy, but remember that a bad HR interview could end your chances of getting the job even after passing all the previous obstacles (aptitude test, technical round, etc.). The key here is to remain polite and confident. Interviews can be long and dreary so don’t forget to wear a smile!</p>
  ...
  <div class="col-md-6">
    <img src="eze_images/hr_interview.png" alt="" class='img-fluid' id='recruitingimages'>
  </div>
</div>
     <!-- <div class="col-md-10">
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="eze_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="eze_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="eze_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
