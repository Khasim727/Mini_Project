...
<head>
  ...
  <link rel="icon"  href="aptroid_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="aptroid_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">Mini_Project</a>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="2000">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <img src="aptroid_images/aptroid1.png" class="d-block  w-100" alt="Image 1">
          </div>
          <div class="carousel-item" data-bs-interval="1500">
            <img src="aptroid_images/aptroid.jpg" class="d-block w-100" alt="Image 2">
          </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="para" style="font-size:20px">Aptroid Technologies is a comprehensive, multi-channel marketing solution that unifies and unlocks data, driving return on marketing investment.he average Aptroid Technologies salary ranges from approximately ₹3.2 Lakhs per year for a Software Engineer to ₹3.6 Lakhs per year for a Digital Marketing Executive.The overall rating of Aptroid Consulting (India) is 2.4, with Salary & Benefits being rated at the top and given a rating of 3.2. However, Work-Life balance is rated the lowest at 2.2.</p>
...
<div class="row">
  <div class="col-md-10">
    ...
    Written Test - (Arithmetic, Logical Reasoning, Verbal Ability & Technical.)<br>
    Technical Rounds (Face to Face)<br>
    Managerial Technical Rounds.<br>
    HR Round.<br>
      The Aptroid software recruitment process consists of four rounds of selection and includes:</p>
...
<div class="col-md-6 text-align-center">
     ...
     <div class="col-md-6">
      ...
      <img src="aptroid_images/apptitude.png" alt="" class="img-fluid"  id='recruitingimages'>
     </div>
...
<div class="row mt-2">
  <div class="col-md-6">
    <img src="aptroid_images/interview.png" alt="" class='img-fluid'  id='recruitingimages'>
  </div>
  <div class="col-md-6">
...
<div class="row">
  ...
  <div class="col-md-6">
    <img src="aptroid_images/Managerial Interview.png" alt="" class='img-fluid' id='recruitingimages'>
  </div>
</div>
...
<div class="row">
  <div class="col-md-6">
  <img src="aptroid_images/hr_interview.png" alt="" class="img-fluid" id='recruitingimages'>
  </div>
  <div class="col-md-6">
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="aptroid_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="aptroid_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="aptroid_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
