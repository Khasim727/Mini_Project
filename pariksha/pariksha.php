...
<html lang="en">
<head>
  <title>Pariksha company</title>
  <link rel="icon"  href="pariksha_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="pariksha_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">MINI_PROJECT</a>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <img src="pariksha_images/pariksha1.png" class="d-block  w-100" alt="Image 1">
          </div>
          <div class="carousel-item" data-bs-interval="3000">
            <img src="pariksha_images/pariksha1.png" class="d-block w-100" alt="Image 2">
          </div>
          <div class="carousel-item" data-bs-interval="3000">
            <img src="pariksha_images/pariksha1.png"class="d-block  w-100" alt="Image 3">
          </div>
        </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="para">India's largest vernacular EdTech company for the mobile 1st internet users of India. \To become the world's largest test prep company.Provider of web-based assessment platform for preparing multiple exams. Raised a total funding of $3.39M over 6 rounds from 94 investors.It was founded in 2015 and located in Pune, India.</p> <br>
                <p class="para">Pariksha is the largest vernacular EdTech company. It is solving the massive problem of accessibility and affordability.Developer of an online test preparation platform intended to help aspirants learn, practice, and prepare for state government job exams. The company's platform offers a subscription-based, affordable, vernacular program that is based on the analytics and gamification model and comes with adaptive testing and mastery learning, enabling students to prepare for examinations in a convenient and enriching manner.</p> <br>

                <p class="para">Provider of web-based assessment platform for preparing multiple exams. The platform offers analytics-driven solutions, gamification solutions, and an adaptive learning-based assessment platform for students to prepare for examinations. It tracks the performance of the students in real-time and provides continuous feedback and reports. Features include all India mock tests with ranks, vernacular-based, gamified personalized practice sessions, adaptive testing, graphical analytics insights, performance comparison tool, and more. The platform also offers online courses for exams such as MPPSC, BPSC, RAS, UPSI, and more. Its mobile app is available for Android devices.</p>
        </div>
...
<div class="row">
  <div class="col-md-10">
    <p class="para"> 
    Average annual salary in Pariksha.Co is INR 5.8 lakhs . Salary estimates are based on 81 Pariksha.Co latest salaries received from various employees of Pariksha.Co.</p>
    <p class="para">Software Development Engineer salary is 10.5 Lakhs per year based on 6 salaries.The average Pariksha salary ranges from approximately ₹ 2,45145 per year for Developer to ₹ 8,37066 per year for Director of Business Development.
 </p>
   
    <UL STYLE="FONT-SIZE:20PX"> <li>Step 1- Written/Aptitude test: The first round for most of the companies is written round. ... </li>
    <li>Step 2- Group Discussion</li>
    <li>Step 3 - Technical interview Round: The next round is a technical interview. ...</li>
    <li>Step 4 -  HR interview round: The HR interview round is the last round where candidates are judged on the basis of their communication skills, soft skills, confidence level, etc.</li></UL><br>
  </div>
</div>
...
<div class="col-md-6 text-align-center">
     ...
     <div class="col-md-6"><BR><BR><BR><br>
      ...
      <img src="pariksha_images/apptitude.png" alt="" class="img-fluid"  id='recruitingimages'>
     </div>
...
<div class="row mt-2">
<div class="col-md-6"><br><br><br><br>
    <img src="pariksha_images/gd.jpg" alt="" class='img-fluid'  id='recruitingimages'>
    </div>
  <div class="col-md-6">
    <br>
...
<div class="col-md-6"><br><br><br><br><br>
    <img src="pariksha_images/interview.png" alt="" class='img-fluid'  id='recruitingimages'>
  </div>
</div>
...
<div class="col-md-6"><br><br><br><br><br><br>
  <img src="pariksha_images/hr_interview.png" alt="" class="img-fluid" id='recruitingimages'>
  </div>
  <div class="col-md-6">
    <br>
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="pariksha_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="pariksha_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="pariksha_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
