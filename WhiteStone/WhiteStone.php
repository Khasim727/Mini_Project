...
<html lang="en">
<head>
  <title>WhiteStone Company</title>
  <link rel="icon"  href="WhiteStone_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="WhiteStone_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">MINI_PROJECT</a>
    ...
    <div class="col-md-12">
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
       ...
       <div class="carousel-item active">
        ...
        <img src="WhiteStone_images/WhiteStone1.jpg" class="d-block  w-100" alt="Image 1">
          </div>
          <div class="carousel-item" data-bs-interval="3000">
            <img src="WhiteStone_images/WhiteStone2.jpg" class="d-block w-100" alt="Image 2">
          </div>
          <div class="carousel-item" data-bs-interval="3000">
            <img src="WhiteStone_images/WhiteStone3.jpg"class="d-block  w-100" alt="Image 3">
          </div>
        </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
           ...
           <p class="para">
           Whitestone Companies is comprised of four specialties; real estate investment, property management, commercial design and construction management, providing end-to-end support on projects for our investors and stakeholders.Whitestone Marketing PVT LTD is a Non-govt company, incorporated on 27 Nov, 1995. It's a private unlisted company and is classified as'company limited by shares'.
           </p>

           <p class="para">Whitestone Companies is comprised of four specialties, real estate investment, property management, commercial design, and construction management.Whitestone Company focuses on purpose-driven commercial real estate development projects, that create value for the clients and for the community.Company's authorized capital stands at Rs 38.7 lakhs and has 25.839794% paid-up capital which is Rs 10.0 lakhs.

           </P>
           <p class="para">Whitestone Marketing PVT LTD is majorly in Trading business from last 28 years and currently, company operations are strike off.</p>
           </div>
    </div>
</div>
...
<div class="row">
  <div class="col-md-10">
    <p class="para"> Prepare yourself for your interview at THE WHITESTONE GROUP by browsing Interview questions and processes from real candidates.Average annual salary in Whitestone Projects is INR 3.9 lakhs .</p>
 <p class="para">The interview process was really smooth and the technical team panel was skilled.</p>
...
<div class="col-md-6"><BR><BR><BR><br>
      ...
      <img src="WhiteStone_images/apptitude.png" alt="" class="img-fluid"  id='recruitingimages'>
     </div>
...
<div class="col-md-6"><br><br><br><br><br>
    <img src="WhiteStone_images/interview.png" alt="" class='img-fluid'  id='recruitingimages'>
  </div>
</div>
...
<div class="col-md-6"><br><br><br><br><br><br>
  <img src="WhiteStone_images/hr_interview.png" alt="" class="img-fluid" id='recruitingimages'>
  </div>
  <div class="col-md-6">
    <br>
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="WhiteStone_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="WhiteStone_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="WhiteStone_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
