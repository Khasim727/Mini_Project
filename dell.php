...
<head>
  ...
  <link rel="icon"  href="dell_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="dell_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">Mini_Project</a>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="2000">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <img src="dell_images/dell.jpg" class="d-block  w-100" alt="Image 1">
          </div>
          <div class="carousel-item" data-bs-interval="2000">
            <img src="dell_images/dell2.jpg" class="d-block w-100" alt="Image 2">
          </div>
          <div class="carousel-item" data-bs-interval="2000">
            <img src="dell_images/dell3.jpg"class="d-block  w-100" alt="Image 3">
          </div>
        </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="para">Our story began with a belief and a passion: that everybody should have easy access to the best technology anywhere in the world.</p>
                <p class="para">That was in 1984 in Michael Dell’s University of Texas dorm room. Today, Dell Technologies is instrumental in changing the digital landscape the world over. </p>
                <p class="para">We are among the world’s leading technology companies helping to transform people’s lives with extraordinary capabilities. From hybrid cloud solutions to high-performance computing to ambitious social impact and sustainability initiatives, what we do impacts everyone, everywhere.</p>
</div>
...
<div class="row">
  <div class="col-md-10">
    <p class="para"> 
    There isn't a day that goes by when Dell team members are not geeking out about the technology and incredible things that we get to work on. From engineers to data scientists, Dell employees love celebrating all the amazing things we're doing to change the way the world lives. <br>
      The Dell recruitment process consists of three rounds of selection and includes:
       
      
      <p class="para">In order to be eligible you need to have a minimum of 65% throughout your degree with no backlog. A gap in career up to a maximum of two years is permissible but with a valid explanation.</p>
...
<div class="col-md-6 text-align-center">
     ...
     <div class="col-md-6">
      ...
      <img src="dell_images/apptitude.png" alt="" class="img-fluid"  id='recruitingimages'>
     </div>
...
<div class="row mt-2">
  <div class="col-md-6">
    <img src="dell_images/interview.png" alt="" class='img-fluid'  id='recruitingimages'>
  </div>
  <div class="col-md-6">
...
<div class="col-md-6">
      ...
      <img src="dell_images/hr_interview.png.png" alt="" class="img-fluid"  id='recruitingimages'>
     </div>
     <div class="row">
<div class="col-md-6 text-align-center">
     ...
     <div class="col-md-6">
      ...
      <img src="dell_images/hr_interview.png" alt="" class="img-fluid"  id='recruitingimages'>
     </div>
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="dell_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
...
<?php
    ...
    $PositiveScript = 'C:\xampp\new\htdocs\miniproject\khasim\python\dell_pos.py'; //python file path
...
?>
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="dell_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
          <h4 class="card-title">Negitive</h4>
          <p class="card-text">
          <?php
    $pythonPath = "C:\\Users\\91630\\AppData\\Local\\Programs\\Python\\Python311\\pythonw.exe"; //python interpreter
    $NegtiveScript = 'C:\xampp\new\htdocs\miniproject\khasim\python\dell_neg.py'; //python file path
...
?>
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="dell_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
