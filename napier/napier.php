...
<head>
  ...
  <link rel="icon"  href="napier_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="napier_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">Mini_Project</a>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="2000">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <img src="napier_images/napier1.jpg" class="d-block  w-100" alt="Image 1">
          </div>
          <div class="carousel-item" data-bs-interval="1500">
            <img src="napier_images/napier2.jpg" class="d-block w-100" alt="Image 2">
          </div>
          <div class="carousel-item" data-bs-interval="1500">
            <img src="napier_images/napier3.jpg"class="d-block  w-100" alt="Image 3">
          </div>
        </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="para">Napier Healthcare has an overall rating of 2.8 out of 5, based on over 201 reviews left anonymously by employees. 49% of employees would recommend working at Napier Healthcare to a friend and 44% have a positive outlook for the business.</p>
            <p class="para"> Napier is the nexus of the largest wool centre in the Southern Hemisphere, and it has the primary export seaport for northeastern New Zealand – which is the largest producer of apples, pears, and stone fruit in New Zealand.</p>
</div>
...
<div class="row">
  <div class="col-md-10">
    <p class="para"> 
    Napier Healthcare Solutions interview process usually has 3-4 rounds. The most common rounds in the Napier Healthcare Solutions interview process are Resume Shortlist, One-on-one Round and Technical. <br>
    The hiring process at Analog Devices is technical and multifaceted. It typically involves an assessment, technical interviews, and group and HR interviews.<br>
      The naipher technologies recruitment process consists of three rounds of selection and includes:
...
<div class="col-md-6 text-align-center">
     ...
     <div class="col-md-6">
      ...
      <img src="napier_images/apptitude.png" alt="" class="img-fluid"  id='recruitingimages'>
     </div>
...
<div class="row mt-2">
  <div class="col-md-6">
    <img src="napier_images/interview.png" alt="" class='img-fluid'  id='recruitingimages'>
  </div>
  <div class="col-md-6">
...
<div class="row">
  <div class="col-md-6">
  <h3 align="center" id='headings'>3.Group discission</h3>
  <p class=para>
    
          A comprehensive technique to judge the suitability of an individual and his appropriateness for admission, scholarship, job, etc. GD assesses the overall personality – thoughts, feelings and behaviour - of an individual in a group.</p>
  </div>
  <div class="col-md-6">
    <img src="napier_images/group.jpg" alt="" class='img-fluid' id='recruitingimages'>
  </div>
</div>
...
<div class="row">
  <div class="col-md-6">
  <img src="napier_images/hr_interview.png" alt="" class="img-fluid" id='recruitingimages'>
  </div>
  <div class="col-md-6">
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="napier_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="napier_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="napier_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
