...
<html lang="en">
<head>
  <title>Vadafone Company</title>
  <link rel="icon"  href="Vadafone_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="Vadafone_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">MINI_PROJECT</a>
    ...
    <div class="col-md-12">
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
       ...
       <div class="carousel-item active">
        ...
        <img src="Vadafone_images/Vadafone2 (1).jpg" class="d-block  w-100" alt="Image 1">
          </div>
          <div class="carousel-item" data-bs-interval="3000">
            <img src="Vadafone_images/Vadafone2 (2).jpg" class="d-block w-100" alt="Image 2">
          </div>
          <div class="carousel-item" data-bs-interval="3000">
            <img src="Vadafone_images/Vadafone2 (3).jpg"class="d-block  w-100" alt="Image 3">
          </div>
        </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="para"> Vodafone Group Plc is a British multinational telecommunications company. Its registered office and global headquarters are in Newbury, Berkshire, England. It predominantly operates services in Asia, Africa, Europe, and Oceania.As of January 2023, Vodafone owns and operates networks in 21 countries, with partner networks in 47 further countries.Its Vodafone Global Enterprise division provides telecommunications and IT services to corporate clients in 150 countries
</p>
           <p class="para">Vodafone has a primary listing on the London Stock Exchange and is a constituent of the FTSE 100 Index. The company has a secondary listing on Nasdaq.The name Vodafone comes from voice data fone (the latter a sensational spelling of "phone"), chosen by the company to "reflect the provision of voice and data services over mobile phones.The evolution of Vodafone started in 1981 with the establishment of the Racal Strategic Radio Ltd subsidiary of Racal Electronics, the UK's largest maker of military radio technology, which formed a joint venture with Millicom called 'Racal', which evolved into the present VodafoneVodafone Idea Limited is an Aditya Birla Group and Vodafone Group partnership. It is India's leading telecom service provider. The Company provides pan India Voice and Data services across 2G, 3G and 4G platform.
Vodafone Group Plc is a British multinational telecommunications company. Its registered office and global headquarters are in Newbury, Berkshire, England. It predominantly operates services in Asia, Africa, Europe, and Oceania</P>

           <p class="para">Vodafone Global Enterprise Limited is a multinational company which provides telecommunications and information technology services to large corporations, and a wholly owned subsidiary of Vodafone Group Plc. It is headquartered in London, England and was established in April 2007.</P>
           </div>
    </div>
</div>
...
<div class="row">
  <div class="col-md-10">
    <p class="para">Average annual salary in Vodafone Idea is INR 8.6 lakhs .</p>
 <p class="para">Vodafone pays its employees an average of ₹1,013,771 a year. Salaries at Vodafone range from an average of ₹343,873 to ₹2,700,134 a year</p>
 <p class="para">What is company standard salary?
The average Business Standard salary ranges from approximately ₹1.8 Lakhs per year for a Sales Executive to ₹15.0 Lakhs per year for a Product Manager. Salary estimates are based on 577 Business Standard salaries received from various employees of Business Standard.</p>
...
<div class="col-md-6 text-align-center"><br><br>
     ...
     <p class="para"> An Online Test of 50 marks for 50 minutes is prepared for the candidates. </p>
     ...
     <div class="col-md-6"><BR><BR><BR><br>
      ...
      <img src="Vadafone_images/apptitude.png" alt="" class="img-fluid"  id='recruitingimages'>
     </div>
...
<div class="row mt-2">
<div class="col-md-6"><br><br><br><br>
    <img src="Vadafone_images/GROUP.jpEg" alt="" class='img-fluid'  id='recruitingimages'>
    </div>
  <div class="col-md-6">
    <br>
...
<div class="col-md-6"><br><br><br><br><br>
    <img src="Vadafone_images/interview.png" alt="" class='img-fluid'  id='recruitingimages'>
  </div>
</div>
...
<div class="col-md-6"><br><br><br><br><br><br>
  <img src="Vadafone_images/hr_interview.png" alt="" class="img-fluid" id='recruitingimages'>
  </div>
  <div class="col-md-6">
    <br>
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="Vadafone_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="Vadafone_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="Vadafone_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
