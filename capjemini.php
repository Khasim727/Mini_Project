...
<html lang="en">
<head>
  <title>capjemini company</title>
  <link rel="icon"  href="cap_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="cap_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">MINI_PROJECT</a>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="1000">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <img src="cap_images/cap1.jpg" class="d-block  w-100" alt="Image 1">
          </div>
          <div class="carousel-item" data-bs-interval="1000">
            <img src="cap_images/cap2.jpg" class="d-block w-100" alt="Image 2">
          </div>
          <div class="carousel-item" data-bs-interval="1000">
            <img src="cap_images/cap3.jpg"class="d-block  w-100" alt="Image 3">
          </div>
        </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="para">Capgemini partners with companies to transform and manage their business by unlocking the value of technology. As a leading strategic partner to companies around the world, we have leveraged technology to enable business transformation for more than 50 years.It is an information technology consulting company specialising in technology and engineering professional services.You will get opportunities to be bold, try new things and really make your mark. Our strategic partnership with technology leaders, award-winning Capgemini Research Institute and alliances with startups provides you with an ecosystem to innovate fueled by an entrepreneurial spirit.</p> <br>

                <p class="para">Capgemini SE (Capgemini) provides information technology, consulting, and outsourcing services. The company also offers digital services, technology solutions, cloud services, artificial intelligence solutions, and cybersecurity and engineering services.The freedom to explore and innovate. Our strategic partnerships with leading organizations, award-winning Capgemini Research Institute, and alliances with startups provide you with an ecosystem to innovate, and fuel your entrepreneurial spirit.</p> <br>

                <p class="para">Capgemini is a global leader in partnering with companies to transform and manage their business by harnessing the power of technology. Mission: With you, we create and deliver business and technology solutions that fit your needs and drive the results you want.Capgemini salary for freshers with qualifications is offered at the lowest level of Rs. 35,000 per annum to Rs. 56,500 per month plus night shift allowance as applicable in any location.Always keep a cheerful attitude and a smile on your face. Read about the company. Understand the company's services and product lines, as well as its mission and philosophy. Employers expect you to know who the company is, what it does, and how it relates to your professional goals.</p>
        </div>
...
(₹1.4L/yr - ₹6.1L/yr)
    ...
    <tr>
      ...
      Senior Consultant C1 <br>

Experience: 3 - 12 yrs

</td>
      <td>₹ 15,51,803/year <br>
(₹6.4L/yr - ₹27.2L/yr)
...
<div class="row">
  <div class="col-md-10">
    <p class="para"> 
      capjemini is one of India’s leading IT services, consulting and business solutions organization with An average salary for a fresher at Capgemini is between 4 lakhs and 6 lakhs. <br>
      The PUNE-headquartered company is one of the best places to work if you are looking for a career in the IT industry <br>
      The capjemini recruitment process consists of THREE rounds of selection and includes:
...
<div class="col-md-6 text-align-center">
     ...
     <div class="col-md-6">
      ...
      <img src="cap_images/apptitude.png" alt="" class="img-fluid"  id='recruitingimages'>
     </div>
...
<div class="row mt-2">
  <div class="col-md-6">
    <img src="cap_images/interview.png" alt="" class='img-fluid'  id='recruitingimages'>
  </div>
  <div class="col-md-6">
...
<p class='para'>With Capjemini being named one of the world’s top employers by the Top Employer Institute for consecutive years, a career at this company could be rich and rewarding experience for job seekers.

So what are you waiting for? Go ahead and apply now!</p>
</div>
  <div class="col-md-6">
  <img src="cap_images/hr_interview.png" alt="" class="img-fluid" id='recruitingimages'>
  </div>
</div>
     <!-- <div class="col-md-10">
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="cap_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
...
<?php
    ...
    $PositiveScript = 'C:\xampp\new\htdocs\miniproject\khasim\python\capjemini_pos.py'; //python file path
...
?>
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="cap_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
          <h4 class="card-title">Negative</h4>
          <p class="card-text">
          <?php
    $pythonPath = "C:\\Users\\91630\\AppData\\Local\\Programs\\Python\\Python311\\pythonw.exe"; //python interpreter
    $NegtiveScript = 'C:\xampp\new\htdocs\miniproject\khasim\python\capjemini_neg.py'; //python file path
...
?>
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="cap_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
          <h4 class="card-title">Netural</h4>
          <p class="card-text">
          <?php
    $pythonPath = "C:\\Users\\91630\\AppData\\Local\\Programs\\Python\\Python311\\pythonw.exe"; //python interpreter
    $NeturalScript = 'C:\xampp\new\htdocs\miniproject\khasim\python\capjemini_netural.py'; //python file path
