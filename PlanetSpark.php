...
<html lang="en">
<head>
  <title>PlanetSpark Company</title>
  <link rel="icon"  href="PlanetSpark_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="PlanetSpark_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">MINI_PROJECT</a>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <img src="PlanetSpark_images/PlanetSpark1.png" class="d-block  w-100" alt="Image 1">
          </div>
          <div class="carousel-item" data-bs-interval="3000">
            <img src="PlanetSpark_images/PlanetSpark2.png" class="d-block w-100" alt="Image 2">
          </div>
          <div class="carousel-item" data-bs-interval="3000">
            <img src="PlanetSpark_images/PlanetSpark3.png"class="d-block  w-100" alt="Image 3">
          </div>
        </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="para">PlanetSpark platform leverages powerful technology to provide live online classes to K8 learners on English Communication, Public Speaking, Grammar, Creative Writing, Debating, Vlogging and other 'new age' skills.The company's platform provides child cognitive psychology and learning pedagogy and presents it in an engaging and gamified way for English and Mathematics learning, enabling students to learn and develop their skills through gamification.</p> <br>

                <p class="para">Global headquarters for Planet Spark is located in Gurgaon,Haryana,India.Planetspark is a great platform to work to gain knowledge experience and exposure. It's provide benefit and flexible to both teacher and student. They have a great working policy and working environment. We get our salary on 7th of every month</p>
                <p class="para">PlanetSpark platform leverages powerful technology to provide live online classes to K8 learners on English Communication, Public Speaking, Grammar, Creative Writing, Debating, Vlogging and other 'new age' skills.PlanetSpark is on a journey to make the traditional and unorganized tuitions obsolete through its virtual classroom.</p></div>
...
<div class="row">
  <div class="col-md-10">
    <p class="para"> The average Planet Spark salary ranges from approximately ₹1.8 Lakhs per year for a Primary Teacher to ₹31.2 Lakhs per year for a Associate Vice President. Salary estimates are based on 2k Planet Spark salaries received from various employees of Planet Spark.</p>
...
<div class="col-md-6 text-align-center"><br><br>
     ...
     <div class="col-md-6"><BR><BR><BR><br>
      ...
      <img src="PlanetSpark_images/apptitude.png" alt="" class="img-fluid"  id='recruitingimages'>
     </div>
</div>

<div class="row mt-2">
<div class="col-md-6"><br><br><br><br>
    <img src="PlanetSpark_images/gd.jpg" alt="" class='img-fluid'  id='recruitingimages'>
    </div>
  <div class="col-md-6">
    <br>
...
<div class="col-md-6"><br><br><br><br><br>
    <img src="PlanetSpark_images/interview.png" alt="" class='img-fluid'  id='recruitingimages'>
  </div>
</div>
...
<div class="col-md-6"><br><br><br><br><br><br>
  <img src="PlanetSpark_images/hr_interview.png" alt="" class="img-fluid" id='recruitingimages'>
  </div>
  <div class="col-md-6">
    <br>
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="PlanetSpark_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    $PositiveScript = 'C:\xampp\new\htdocs\miniproject\khasim\python\planetspark_pos.py'; //python file path
...
?>
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="PlanetSpark_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
          <h4 class="card-title">Negative</h4>
          <p class="card-text">
          <?php
    $pythonPath = "C:\\Users\\91630\\AppData\\Local\\Programs\\Python\\Python311\\pythonw.exe"; //python interpreter
    $NegtiveScript = 'C:\xampp\new\htdocs\miniproject\khasim\python\planetspark_neg.py'; //python file path
...
?>
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="PlanetSpark_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
          ...
          <p class="card-text">
            ...
            <?php
    $pythonPath = "C:\\Users\\91630\\AppData\\Local\\Programs\\Python\\Python311\\pythonw.exe"; //python interpreter
    $NeturalScript = 'C:\xampp\new\htdocs\miniproject\khasim\python\planetspark_netural.py'; //python file path
