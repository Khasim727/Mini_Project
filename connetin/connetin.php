...
<head>
  ...
  <link rel="icon"  href="connetin_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="connetin_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">Mini_Project</a>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="2000">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <img src="connetin_images/connetin1.jpg" class="d-block  w-100" alt="Image 1">
          </div>
          
          <div class="carousel-item" data-bs-interval="2000">
            <img src="connetin_images/connetin3.jpeg"class="d-block  w-100" alt="Image 3">
          </div>
        </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="para">Connetin is a Business Networking platfrom connecting MSME’s to oppurtunities. Our Platform helps businesses to digitalise, Network and Grow their connections. Aims to grow the MSME sector through Innovations, Connetin is one step to take sector’s growth to next level.Although, sector faces lots of problems which are not yet addressed. We observed that if some of the problems are solved, MSME sector has a Huge potential to grow exponentially.</p>
</div>
...
<div class="row">
  <div class="col-md-10">
    <p class="para"> 
    t is a process that involves everything from identifying, attracting, screening, shortlisting, interviewing, selecting, hiring, and onboarding employees. The recruitment teams can be large or small depending on the size of an organization.<br>
      The connetin recruitment process consists of three rounds of selection and includes:
...
<div class="col-md-6 text-align-center">
     ...
     <div class="col-md-6">
      ...
      <img src="connetin_images/apptitude.png" alt="" class="img-fluid"  id='recruitingimages'>
     </div>
...
<div class="row mt-2">
  <div class="col-md-6">
    <img src="connetin_images/interview.png" alt="" class='img-fluid'  id='recruitingimages'>
  </div>
  <div class="col-md-6">
...
Most candidates tend to think that the HR interview is easy, but remember that a bad HR interview could end your chances of getting the job even after passing all the previous obstacles (aptitude test, technical round, etc.). The key here is to remain polite and confident. Interviews can be long and dreary so don’t forget to wear a smile!</p>
  ...
  <div class="col-md-6">
    <img src="connetin_images/hr_interview.png" alt="" class='img-fluid' id='recruitingimages'>
  </div>
</div>
     <!-- <div class="col-md-10">
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="connetin_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="connetin_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="connetin_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
