...
<html lang="en">
<head>
  <title>Pinscale Company</title>
  <link rel="icon"  href="pinscale_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="pinscale_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">MINI_PROJECT</a>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <img src="pinscale_images/pinscale1.jpg" class="d-block  w-100" alt="Image 1">
          </div>
          <div class="carousel-item" data-bs-interval="3000">
            <img src="pinscale_images/pinscale2.jpg" class="d-block w-100" alt="Image 2">
          </div>
          <div class="carousel-item" data-bs-interval="3000">
            <img src="pinscale_images/pinscale3.jpg"class="d-block  w-100" alt="Image 3">
          </div>
        </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="para">Pinscale Technologies Private Limited is an unlisted private company incorporated on 24 August, 2021. It is classified as a private limited company and is located in Rangareddi, Telangana. It's authorized share capital is INR 62.00 cr and the total paid-up capital is INR 61.10 cr.The current status of Pinscale Technologies Private Limited is - Active.</p> <br>
                <p class="para">The last reported AGM (Annual General Meeting) of Pinscale Technologies Private Limited, per our records, was held on 30 June, 2022.Pinscale Technologies Private Limited has three directors - Sheshasai Vuppalanchi, Sriram Nimmagadda, and others.The company has 3 directors and no reported key management personnel.The longest serving directors currently on board are Sheshasai Vuppalanchi, Sriram Nimmagadda and Praneetha Moturi who were appointed on 24 August, 2021. They have been on the board for 1 years and 10 months.

Sheshasai Vuppalanchi has the largest number of other directorships with a seat at a total of 2 companies. In total, the company is connected to 1 other companies through its directors.</p> <br>
                <p class="para">PINscale Technologies employs 1,001 to 5,000 employees in India.Global headquarters for PINscale Technologies is located in Hyderabad,Telangana,India.The overall rating of PINscale Technologies is 4.7, with Skill development being rated at the top and given a rating of 4.7. However, Company culture is rated the lowest at 4.4. To know first hand how is it like to work at PINscale Technologies read detailed reviews by job profile, department and location in the reviews section..</p>
        </div>
...
<div class="row">
  <div class="col-md-10">
    <p class="para">Get detailed salary information for salaries of popular job profiles in PINscale Technologies: Software Development Engineer 1: ₹ 9,10,000 per year, Business Development Manager: ₹ 18,00,000 per year and many more. Click here to view detailed PINscale Technologies Salaries.50% of employees reported the working days at PINscale Technologies as Other, whereas 25% reported them as Monday to Friday.50% employees reported the work timings at PINscale Technologies as flexible. Whereas, 50% reported it as strict, with a majority as 9 am - 6 pm.</p>
    <p class="para">The hiring process is the process of reviewing applications, selecting the right candidates to interview, testing candidates, choosing between candidates to make the hiring decision and performing various pre-employment tests and checks.The hiring process all depends on the company. Normally for an entry level, hiring the candidate has to go for Aptitude and interviewS
 </p>
   
    <UL STYLE="FONT-SIZE:20PX"> <li>Step 1-Technical Aptitude </li>
...
<div class="col-md-6"><BR><BR><BR><br>
      ...
      <img src="pinscale_images/apptitude.png" alt="" class="img-fluid"  id='recruitingimages'>
     </div>
...
<div class="col-md-6"><br><br><br><br><br>
    <img src="pinscale_images/interview.png" alt="" class='img-fluid'  id='recruitingimages'>
  </div>
</div>
...
<div class="row">
<div class="col-md-6"><br><br><br><br>
  <img src="pinscale_images/hr_interview.png" alt="" class="img-fluid" id='recruitingimages'>
  </div>
  <div class="col-md-6">
    <br>
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="pinscale_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="pinscale_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="pinscale_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
