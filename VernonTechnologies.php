...
<html lang="en">
<head>
  <title>VernonTechnologies Company</title>
  <link rel="icon"  href="VernonTechnologies_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="VernonTechnologies_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">MINI_PROJECT</a>
    ...
    <div class="col-md-12">
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
       ...
       <div class="carousel-item active">
        ...
        <img src="VernonTechnologies_images/VernonTechnologies1.jpg" class="d-block  w-100" alt="Image 1">
          </div>
          <div class="carousel-item" data-bs-interval="3000">
            <img src="VernonTechnologies_images/VernonTechnologies2.jpg" class="d-block w-100" alt="Image 2">
          </div>
          <div class="carousel-item" data-bs-interval="3000">
            <img src="VernonTechnologies_images/VernonTechnologies3.jpg"class="d-block  w-100" alt="Image 3">
          </div>
        </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
           ...
           <p class="para">
           Vernon Technology Solution is an innovative Technology support company that has a track record for success in technology and computer rentals. We have branches all over North America and a network of high caliber partners in urban centers. We deliver equipment and quality service quickly and effectively across the country.
.Registered in 2005 ,Trinidad And Tobago Vernon Technologies Ltd has gained immense expertise in supplying & trading of Pharmaceuticals productsPharmaceuticals & chemicals etc. The supplier company is located in Sangre Grande, Sangre Grande and is one of the leading sellers of listed products. Buy Pharmaceuticals productsPharmaceuticals & chemicals in bulk from us for the best quality products and service.
           </p>

           <p class="para">We offer simple, turn-key computer and business rentals, quality event support, secure asset management, and computer sales and service. We provide a unique flexibility that helps us address the technology needs and adhere to the financial goals of our valued clients.Specialties......
...
<div class="row">
  <div class="col-md-10">
    <p class="para">Average hourly pay for a Program is $51 per hour. </p>
...
<div class="col-md-6"><BR><BR><BR><br>
      ...
      <img src="VernonTechnologies_images/apptitude.png" alt="" class="img-fluid"  id='recruitingimages'>
     </div>
...
<div class="col-md-6"><br><br><br><br><br>
    <img src="VernonTechnologies_images/interview.png" alt="" class='img-fluid'  id='recruitingimages'>
  </div>
</div>
...
<div class="col-md-6"><br><br><br><br><br><br>
  <img src="VernonTechnologies_images/hr_interview.png" alt="" class="img-fluid" id='recruitingimages'>
  </div>
  <div class="col-md-6">
    <br>
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="VernonTechnologies_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
...
$PositiveScript = 'C:\xampp\new\htdocs\miniproject\khasim\python\vetrnon_pos.py'; //python file path
...
?>
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="VernonTechnologies_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
          <h4 class="card-title">Negative</h4>
          <p class="card-text">
          <?php
    $pythonPath = "C:\\Users\\91630\\AppData\\Local\\Programs\\Python\\Python311\\pythonw.exe"; //python interpreter
    $NegtiveScript = 'C:\xampp\new\htdocs\miniproject\khasim\python\vernon_neg.py'; //python file path
...
?>
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="VernonTechnologies_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
          ...
          <p class="card-text">
            ...
            <?php
    $pythonPath = "C:\\Users\\91630\\AppData\\Local\\Programs\\Python\\Python311\\pythonw.exe"; //python interpreter
    $NeturalScript = 'C:\xampp\new\htdocs\miniproject\khasim\python\vernon_netural.py'; //python file path
