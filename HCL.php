...
<head>
  ...
  <link rel="icon"  href="hcl_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="hcl_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">MINI_PROJECT</a>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="800">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <img src="hcl_images/hcl1.jpg" class="d-block  w-100" alt="Image 1">
          </div>
          <div class="carousel-item" data-bs-interval="1000">
            <img src="hcl_images/hcl2.jpg" class="d-block w-100" alt="Image 2">
          </div>
          <div class="carousel-item" data-bs-interval="1000">
            <img src="hcl_images/hcl2.jpg"class="d-block  w-100" alt="Image 3">
          </div>
        </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="para">HCL Technologies Limited is a leading global IT services company that ...HCL Technologies Limited was incorporated on November 12, 1991 as HCL ...HCL Technologies is one of the top 20 largest publicly-traded companies in India. It is on the Forbes Global 2000 list. Working at HCL would be the right place for you if your focus is on innovation and culture. Here, the personal and professional development of employees is well taken care of.</p> <br>

                <p class="para">HCL Technologies focuses on Transformational Outsourcing, working with...HCL Technologies Limited is a leading global IT services company that helps global enterprises re-imagine and transform their businesses through Digital technology transformation. The Company is primarily engaged in providing a range of software services, business process outsourcing and infrastructure services.</p> <br>

                <p class="para">The Company is primarily engaged in providing a range of software services, business process outsourcing and infrastructure services.HCLTech is a global technology company, home to 225,900+ people across 60 countries, delivering industry-leading capabilities centered around digital, engineering and cloud powered by a broad portfolio of technology services and products. The Products & Platforms segment comprises the HCLTech Software Division, Actian software, Industry Software Division, and an IP partnership with DXC, which together account for a significant part of our Mode 3 revenue.</p>
        </div>
...
<div class="row">
  <div class="col-md-10">
    <p class="para"> 
      HCL is one of India’s leading IT services, consulting and business solutions organization with over 4.0 lakh employees and a presence in 52 countries and 165 offices across the world. <br>
      The NOIDA-headquartered company is one of the best places to work if you are looking for a career in the IT industry <br>
      The HCL recruitment process consists of THREE rounds of selection and includes:
...
<div class="col-md-6 text-align-center">
     ...
     <ul style="font-size:20px">
      ...
      <li>logical and computer fundamentals</li>
     </ul>
     </div>
     <div class="col-md-6">
      
      <img src="hcl_images/apptitude.png" alt="" class="img-fluid"  id='recruitingimages'>
     </div>
...
<div class="row mt-2">
  <div class="col-md-6">
    <img src="hcl_images/interview.png" alt="" class='img-fluid'  id='recruitingimages'>
  </div>
  <div class="col-md-6">
...
<p class='para'>With HCL being named one of the world’s top employers by the Top Employer Institute for consecutive years, a career at this company could be rich and rewarding experience for job seekers.

So what are you waiting for? Go ahead and apply now!</p>
  </div>
  <div class="col-md-6">
  <img src="hcl_images/hr_interview.png" alt="" class="img-fluid" id='recruitingimages'>
  </div>
</div>
     <!-- <div class="col-md-10">
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="hcl_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
...
$PositiveScript = 'C:\xampp\new\htdocs\miniproject\khasim\python\hcl_pos.py'; //python file path
...
?>
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="hcl_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
          <h4 class="card-title">Negative</h4>
          <p class="card-text">
          <?php
    $pythonPath = "C:\\Users\\91630\\AppData\\Local\\Programs\\Python\\Python311\\pythonw.exe"; //python interpreter
    $NegtiveScript = 'C:\xampp\new\htdocs\miniproject\khasim\python\hcl_neg.py'; //python file path
...
?>
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="hcl_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
          ...
          <p class="card-text">
            ...
            <?php
    $pythonPath = "C:\\Users\\91630\\AppData\\Local\\Programs\\Python\\Python311\\pythonw.exe"; //python interpreter
    $NeturalScript = 'C:\xampp\new\htdocs\miniproject\khasim\python\hcl_netural.py'; //python file path
