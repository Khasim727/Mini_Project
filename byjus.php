...
<head>
  ...
  <link rel="icon"  href="byjus_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="byjus_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">Mini_Project</a>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="2000">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <img src="byjus_images/byjus.jpg" class="d-block  w-100" alt="Image 1">
          </div>
          <div class="carousel-item" data-bs-interval="2000">
            <img src="byjus_images/byjus1.jpg" class="d-block w-100" alt="Image 2">
          </div>
          <div class="carousel-item" data-bs-interval="2000">
            <img src="byjus_images/byjus2.jpg"class="d-block  w-100" alt="Image 3">
          </div>
        </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="para">Byju's (stylised as BYJU'S) is an Indian multinational educational technology company, headquartered in Bangalore, Karnataka, India.</p>
            <p class="para"> It was founded in 2011 by Byju Raveendran and Divya Gokulnath. As of March 2022, Byju's was valued at US$22 billion but is down to US$8.5 billion as of June 2023.<br>What is BYJU's famous for?
With a holistic approach towards education, the app makes learning interactive, adaptive, and personalized through its animated videos, games, quizzes, and more. Celebrating every type of learner, BYJU'S programs use technology to adapt to the needs of each student's style and pace.</p>
</div>
...
<div class="row">
  <div class="col-md-10">
    <p class="para"> 
    BYJU'S interview process for freshers usually has 2-3 rounds. The most common rounds in the BYJU'S interview process for freshers are Resume Shortlist, One-on-one Round and HR.<br>
      The Byjus recruitment process consists of three rounds of selection and includes:
...
<div class="row">
  <div class="col-md-6">
  <img src="byjus_images/resume.jpg" alt="" class="img-fluid" id='recruitingimages'>
  </div>
  <div class="col-md-6">
...
<div class="row">
  ...
  <div class="col-md-6">
    <img src="byjus_images/Interview.png" alt="" class='img-fluid' id='recruitingimages'>
  </div>
</div>

<div class="row">
  <div class="col-md-6">
  <img src="byjus_images/hr_interview.png" alt="" class="img-fluid" id='recruitingimages'>
  </div>
  <div class="col-md-6">
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="byjus_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
...
<?php
    ...
    $PositiveScript = 'C:\xampp\new\htdocs\miniproject\khasim\python\byjus_pos.py'; //python file path
...
?>
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="byjus_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
          ...
          <p class="card-text">
            ...
            <?php
    $pythonPath = "C:\\Users\\91630\\AppData\\Local\\Programs\\Python\\Python311\\pythonw.exe"; //python interpreter
    $NegtiveScript = 'C:\xampp\new\htdocs\miniproject\khasim\python\byjus_neg.py'; //python file path
...
?>
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="byjus_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
          ...
          <p class="card-text">
            ...
            <?php
    $pythonPath = "C:\\Users\\91630\\AppData\\Local\\Programs\\Python\\Python311\\pythonw.exe"; //python interpreter
    $NeturalScript = 'C:\xampp\new\htdocs\miniproject\khasim\python\byjus_netural.py'; //python file path
