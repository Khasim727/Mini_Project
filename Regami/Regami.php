...
<html lang="en">
<head>
  <title>Regami Company</title>
  <link rel="icon"  href="Regami_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="Regami_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">MINI_PROJECT</a>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <img src="Regami_images/Regami1.jpg" class="d-block  w-100" alt="Image 1">
          </div>
          <div class="carousel-item" data-bs-interval="3000">
            <img src="Regami_images/Regami2.jpg" class="d-block w-100" alt="Image 2">
          </div>
          <div class="carousel-item" data-bs-interval="3000">
            <img src="Regami_images/Regami3.jpg"class="d-block  w-100" alt="Image 3">
          </div>
        </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="para">Regami was founded to provide world class product development services to companies in various capacities which involves design and development of hardware and software solutions along with deployment and manufacturing services. We believe in designing products with a keen focus on nurturing innovative ideas to help you bring an optimized, technologically advanced, cost-effective solution to the market. Regami helps business move forward, faster by combining deep industry expertise and frictionless technology delivery.</p> <br>

                <p class="para">Our services have applicability across use cases such as Medical Devices, Industrial IoT, Medical IoT, Smart Surveillance, Security, Biometrics, Machine–Vision, Autonomous Guided Vehicles, Smart Parking, Wearables, Drones, Dental Cameras, Surgical Vision Solutions, Telemedicine, Augmented Reality, Virtual Reality, etc.</p>
                <p class="para">At Regami, we’re all about helping today’s businesses elevate their customer experiences and enhance their products, people and processes to enable them to get ahead and stay ahead of marketplace shifts, fickle customer demands and relentless competition.Every Regamian is empowered and driven by our core values which guide us in every step we take with our clients in their journey of bringing successful products to market. </div>
                </p>
...
<div class="row">
  <div class="col-md-10">
    <p class="para"> Average annual salary in Regami Solutions is INR 3.2 lakhs . Salary estimates are based on 21 Regami Solutions latest salaries received from various employees of Regami Solutions.Minimum salary at Regami Solutions depends on the role you are applying for. For Python Developer Intern the minimum salary is ₹1.0 Lakhs per year, for Talent Acquisition Specialist the minimum salary is ₹2.4 Lakhs per year and so on.</p>
    <p class="para">Regami Solutions vacancies for Embedded Systems is recruited through Written-test, Face to Face Interview etc. Regami Solutions Company recruits a lot of candidates every year based on the skills .</p>
...
<div class="col-md-6"><BR><BR><BR><br>
      ...
      <img src="Regami_images/apptitude.png" alt="" class="img-fluid"  id='recruitingimages'>
     </div>
...
<div class="col-md-6"><br><br><br><br><br>
    <img src="Regami_images/interview.png" alt="" class='img-fluid'  id='recruitingimages'>
  </div>
</div>
...
<div class="col-md-6"><br><br><br><br><br><br>
  <img src="Regami_images/hr_interview.png" alt="" class="img-fluid" id='recruitingimages'>
  </div>
  <div class="col-md-6">
    <br>
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="Regami_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="Regami_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="Regami_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
