...
<html lang="en">
<head>
  <title>Primosoft company</title>
  <link rel="icon"  href="primo_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="primo_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">MINI_PROJECT</a>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="1000">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <img src="primo_images/primo1.jpg" class="d-block  w-100" alt="Image 1">
          </div>
          <div class="carousel-item" data-bs-interval="1000">
            <img src="primo_images/primo2.jpg" class="d-block w-100" alt="Image 2">
          </div>
          <div class="carousel-item" data-bs-interval="1000">
            <img src="primo_images/primo3.jpg"class="d-block  w-100" alt="Image 3">
          </div>
        </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="para">Primosoft is a digital marketing agency with specialization in web development, creative content, hosting and advertising services.Primosoft Technologies | 6 followers on LinkedIn. We are a software development company specializing in desktop as well as mobile applications.Free company information from Companies House including registered office address, filing history, accounts, annual return, Primosoft Solution Private Limited is a Private incorporated on 05 August 2015. It is classified as Non-govt company and is registered at . </p> <br>

                <p class="para">Ownership Type, private ; Primary Business type, mca provider ; Category, Company limited by shares ; Sub Category, Indian Non-Government Company..primosoft provides software development, maintenance and independent validation services to companies in finance, insurance, manufacturing and other domains.Infosys is hailed as an employee-friendly organisation. It offers entry-level employees immense employment options in a challenging and stimulating work environment. Check out the factors that have been listed for Infosys by its employees.</p> <br>

                <p class="para">Primosoft Solution Private Limited, established in 2015, is engaged in the Information Technology sector in Pune. Explore their Corporate Structure, .PRIMO SOFT INDIA PRIVATE LIMITED. Primo Soft India Private Limited is an unlisted private company incorporated on 16 October, 2003.Primosoft Solution Private Limited, established in 2015, is engaged in the Information Technology sector in Pune. Explore their Corporate Structure, ...</p>
        </div>
...
<div class="row">
  <div class="col-md-10">
    <p class="para"> 
      Tamil Nadu ; Address. S3 MANCHESTER SQUAREPULIAKULAM ROAD,COIMBATORE,Tamil Nadu,Tamil Nadu,INDIA,641037 ; Company name, Primo Soft ...
Age of Company: 19 Years 7 Months 6 Days<br>
      The Tamilnadu-headquartered company is one of the best places to work if you are looking for a career in the IT industry <br>
      The PRIMOSOFT recruitment process consists of THREE rounds of selection and includes:
...
<div class="col-md-6 text-align-center">
     ...
     <ul style="font-size:20px">
      ...
      <li>logical and thinking</li>
     </ul>
     </div>
     <div class="col-md-6">
      
      <img src="primo_images/apptitude.png" alt="" class="img-fluid"  id='recruitingimages'>
     </div>
...
<div class="row mt-2">
  <div class="col-md-6">
    <img src="primo_images/interview.png" alt="" class='img-fluid'  id='recruitingimages'>
  </div>
  <div class="col-md-6">
  <h3 align="center" id='headings'>2.Coding Test Round</h3>
...
<div class="row">
  ...
  <div class="col-md-6">
  <h3 align="center" id='headings'>3.Technical Round</h3>
...
<p class='para'>With PRIMOSOFT being named one of the world’s top employers by the Top Employer Institute for consecutive years, a career at this company could be rich and rewarding experience for job seekers.

So what are you waiting for? Go ahead and apply now!</p>
  </div>
  <div class="col-md-6">
  <img src="primo_images/hr_interview.png" alt="" class="img-fluid" id='recruitingimages'>
  </div>
</div>
     <!-- <div class="col-md-10">
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="primo_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="primo_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="primo_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
