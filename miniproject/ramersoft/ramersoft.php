...
<html lang="en">
<head>
  <title>Ramersoft company</title>
  <link rel="icon"  href="ramer_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="ramer_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">MINI_PROJECT</a>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="1000">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <img src="ramer_images/ramer1.jpg" class="d-block  w-100" alt="Image 1">
          </div>
          <div class="carousel-item" data-bs-interval="1000">
            <img src="ramer_images/ramer1.jpg" class="d-block w-100" alt="Image 2">
          </div>
          <div class="carousel-item" data-bs-interval="1000">
            <img src="ramer_images/ramer1.jpg"class="d-block  w-100" alt="Image 3">
          </div>
        </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="para">Ramer Software Solutions, an ISO 9001-2015 certified company, established in 2016 with Head Quarters in the “City of Destiny”-Visakhapatnam specializes in delivering Taylor-made Global IT solutions, calibrated services, and core consulting. We provide Enterprise Solutions (SAP, Oracle Apps, and Microsoft Dynamics), Personalize Software Applications, Web and Mobility Application Development, QA/Testing Services, Business Intelligence, Talent Acquisition, Manpower Outsourcing, and IT staffing.</p> <br>

                <p class="para">Our work culture, values, and progressive work environment are a testament to the certification from Great Place to Work Institute. This reflects our commitment to putting employees first and building a workplace culture that nurtures performance, growth, appreciation, and belongingness. It’s also evidence of Ramer Software Solutions’ special focus and efforts in building trust and belongingness with clients and owning pride in value-added services.</p> <br>

                <p class="para">We offer a full bouquet of services from the inception stage to final implementation with pinpoint accuracy in planning, scoping, process re-engineering, customizing, implementation, data conversion, and standard and customized training for these applications.</p>
        </div>
...
<div class="row">
  <div class="col-md-10">
    <p class="para"> 
      Ramersoft is one of India’s leading IT services, consulting and business solutions organization with Average annual salary in Ramer Software Solutions is INR 4.9 lakhs . Salary estimates are based on 109 Ramer Software Solutions latest salaries received from ... <br>
      The Visakhapatnam, Andhra Pradesh.-headquartered company is one of the best places to work if you are looking for a career in the IT industry <br>
      The Ramersoft recruitment process consists of THREE rounds of selection and includes:
...
<div class="col-md-6 text-align-center">
     <h3 align="center" id='headings'>1.WRITTEN TEST AND GD TOPICS</h3>
     ...
     <div class="col-md-6">
      ...
      <img src="ramer_images/apptitude.png" alt="" class="img-fluid"  id='recruitingimages'>
     </div>
...
<div class="row mt-2">
  <div class="col-md-6">
    <img src="ramer_images/interview.png" alt="" class='img-fluid'  id='recruitingimages'>
  </div>
  <div class="col-md-6">
...
<p class='para'>With ramersoft being named one of the world’s top employers by the Top Employer Institute for consecutive years, a career at this company could be rich and rewarding experience for job seekers.

So what are you waiting for? Go ahead and apply now!</p>
  </div>
  <div class="col-md-6">
  <img src="ramer_images/hr_interview.png" alt="" class="img-fluid" id='recruitingimages'>
  </div>
</div>
     <!-- <div class="col-md-10">
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="ramer_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="ramer_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="ramer_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
