...
<html lang="en">
<head>
  <title>Epam Company</title>
  <link rel="icon"  href="epam_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="epam_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">MINI_PROJECT</a>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="1000">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <img src="epam_images/epam1.jpg" class="d-block  w-100" alt="Image 1">
          </div>
          <div class="carousel-item" data-bs-interval="1000">
            <img src="epam_images/epam2.jpg" class="d-block w-100" alt="Image 2">
          </div>
          <div class="carousel-item" data-bs-interval="1000">
            <img src="epam_images/epam3.jpg"class="d-block  w-100" alt="Image 3">
          </div>
        </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="para">EPAM Systems Inc (EPAM Systems) is a technology company that provides software engineering services for software development and digital platforms. The company provides services in customer experience design, business consulting and technology innovation services.Is EPAM Systems a good company to work for? EPAM Systems has an overall rating of 4.2 out of 5, based on over 8,280 reviews left anonymously by employees. 86% of employees would recommend working at EPAM Systems to a friend and 74% have a positive outlook for the business.</p> <br>

                <p class="para">EPAM is a leading global provider of software product development and digital platform engineering services to hundreds of Fortune 500 and 1000 clients located around the world, primarily in North America, Europe, Asia and Australia.EPAM Systems, Inc. is an American company that specializes in software engineering services, digital platform engineering, and digital product design, operating out of Newtown, Pennsylvania.</p> <br>

                <p class="para">About us. Since 1993, EPAM Systems, Inc. (NYSE: EPAM) has leveraged its advanced software engineering heritage to become the foremost global digital transformation services provider – leading the industry in digital and physical product development and digital platform engineering services.Is EPAM Systems a good company to work for? EPAM Systems has an overall rating of 4.2 out of 5, based on over 8,280 reviews left anonymously by employees. 86% of employees would recommend working at EPAM Systems to a friend and 74% have a positive outlook for the business.</p>
        </div>
...
<div class="row">
  <div class="col-md-10">
    <p class="para"> 
    Average EPAM Systems Junior Software Engineer salary in India is ₹ 6.3 Lakhs for less than 1 year of experience to 3 years. Junior Software Engineer salary at EPAM Systems India ranges between ₹ 4.8 Lakhs to ₹ 11.0 Lakhs.<br>
      The PUNE-headquartered company is one of the best places to work if you are looking for a career in the IT industry <br>
      The EPAM recruitment process consists of THREE rounds of selection and includes:
...
<div class="col-md-6 text-align-center">
     ...
     <p class="para">That Consists aptitude test  of four sections and total time allotted is 90 minutes.</p>
     <p>It includes:</p>
     ...
     <div class="col-md-6">
      ...
      <img src="epam_images/apptitude.png" alt="" class="img-fluid"  id='recruitingimages'>
     </div>
...
<div class="row mt-2">
  <div class="col-md-6">
    <img src="epam_images/interview.png" alt="" class='img-fluid'  id='recruitingimages'>
  </div>
  <div class="col-md-6">
...
<p class='para'>With epam being named one of the world’s top employers by the Top Employer Institute for consecutive years, a career at this company could be rich and rewarding experience for job seekers.

So what are you waiting for? Go ahead and apply now!</p>
  </div>
  <div class="col-md-6">
  <img src="epam_images/hr_interview.png" alt="" class="img-fluid" id='recruitingimages'>
  </div>
</div>
     <!-- <div class="col-md-10">
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="epam_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="epam_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="epam_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
