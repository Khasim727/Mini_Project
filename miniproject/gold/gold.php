...
<html lang="en">
<head>
  <title>Golden hills capital company</title>
  <link rel="icon"  href="gold_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="gold_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">MINI_PROJECT</a>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="1000">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <img src="gold_images/shad1.jpg" class="d-block  w-100" alt="Image 1">
          </div>
          <div class="carousel-item" data-bs-interval="1000">
            <img src="gold_images/shad2.jpg" class="d-block w-100" alt="Image 2">
          </div>
          <div class="carousel-item" data-bs-interval="1000">
            <img src="gold_images/shad3.jpg"class="d-block  w-100" alt="Image 3">
          </div>
        </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="para">Golden Hills Capital India Private Limited is majorly in Finance business from last 12 years and currently, company operations are active. Current board members & directors are SANGEETA RAJU and SURESH RAJU . Company is registered in Hyderabad (Telangana) Registrar Office.Address: 1st & 2nd Floor, TK House, Plot 11, Hitex Road, Shilpa Layout, HITEC City, Khanammet, Telangana 500081</p> <br>

                <p class="para">"Golden Hills Capital India Private Limited is a leading provider for data analytics and research providing a comprehensive suite of solutions ranging,Our sharp-focused multi-skilled team serve a diverse range of firms ranging from asset management companies to hedge funds to investment research companies. </p> <br>

                <p class="para">Golden Hills Capital India Private Limited is a Private incorporated on 01 December 2011. It is classified as Non-govt company and is registered at We offer comprehensive suite of solutions ranging from consulting services to institutional grade research, efficient data management and decision-enabling .Golden Hills Capital India Private Limited is an Indian private company incorporated on 01/12/2011 and its registered office address is PLOT NO 27, MC DESIGN .</p>
        </div>
...
<div class="row">
  <div class="col-md-10">
    <p class="para"> 
      ...
      The Global headquarters for Golden Hill Capital is located in Hyderabad. company is one of the best places to work if you are looking for a career in the IT industry <br>
      The  Golden Hill Capital recruitment process consists of THREE rounds of selection and includes:
...
<div class="col-md-6 text-align-center">
     ...
     <div class="col-md-6">
      ...
      <img src="gold_images/apptitude.png" alt="" class="img-fluid"  id='recruitingimages'>
     </div>
...
<div class="row mt-2">
  <div class="col-md-6">
    <img src="gold_images/interview.png" alt="" class='img-fluid'  id='recruitingimages'>
  </div>
  <div class="col-md-6">
...
<p class='para'>With Golden Hills Capital being named one of the world’s top employers by the Top Employer Institute for consecutive years, a career at this company could be rich and rewarding experience for job seekers.

So what are you waiting for? Go ahead and apply now!</p>
  </div>
  <div class="col-md-6">
  <img src="gold_images/hr_interview.png" alt="" class="img-fluid" id='recruitingimages'>
  </div>
</div>
     <!-- <div class="col-md-10">
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="gold_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="gold_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="gold_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
