...
<html lang="en">
<head>
  <title> VAYA GROUP COMPANY</title>
  <link rel="icon"  href="vaya_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="vaya_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">MINI_PROJECT</a>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="1000">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <img src="vaya_images/vaya1.jpg" class="d-block  w-100" alt="Image 1">
          </div>
          <div class="carousel-item" data-bs-interval="1000">
            <img src="vaya_images/vaya2.jpg" class="d-block w-100" alt="Image 2">
          </div>
          <div class="carousel-item" data-bs-interval="1000">
            <img src="vaya_images/vaya3.jpg"class="d-block  w-100" alt="Image 3">
          </div>
        </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="para">The Vaya Group is a talent management consultancy that applies science and precision to the art of talent assessment and development.We guide our clients to a clear definition of "great" and then map the right path to achieving it through innovative thinking, consulting, talent assessment.The overall rating of Vaya Group is 4.0, with Skill development being rated at the top and given a rating of 5.0. However, Salary & Benefits is rated the </p> <br>

                <p class="para">Vaya Group is a leadership and development firm offering a variety of solutions that help your organization and employees reach their full potential.Operator of a boutique talent management consultancy that helps business leaders and organizations achieve the behavioral, cultural and leadership changes ..Vaya Group Overview ; Headquarters: Warrenville, United States ; Size: 1 to 50 Employees ; Founded: 1997 ; Type: Company - Private ; Industry: Business Consulting .</p> <br>

                <p class="para">VAYA GROUPis a Private incorporated company.It is classified as Non-govt company and is registered at We offer comprehensive suite of solutions ranging from consulting services to institutional grade research, efficient data management and decision-enabling .Operator of resorts, hotels and apartments based in Hall in Tirol, Austria. The company provides offers multiple stay options and offers spa facilities ..</p>
        </div>
...
<div class="row">
  <div class="col-md-10">
    <p class="para"> 
    Average annual salary in Vaya Life is INR 9.0 lakhs . Salary estimates are based on 342 Vaya Life latest salaries received from various employees of Vaya Life.<br>
      The Global headquarters for VAYA GROUP in Chennai, Tamil Nadu, India.. company is one of the best places to work if you are looking for a career in the IT industry <br>
      The  VAYA GROUP recruitment process consists of THREE rounds of selection and includes:
...
<div class="col-md-6 text-align-center">
     ...
     <div class="col-md-6">
      ...
      <img src="vaya_images/apptitude.png" alt="" class="img-fluid"  id='recruitingimages'>
     </div>
...
<div class="row mt-2">
  <div class="col-md-6">
    <img src="vaya_images/interview.png" alt="" class='img-fluid'  id='recruitingimages'>
  </div>
  <div class="col-md-6">
...
<p class='para'>With VAYA GROUP being named one of the world’s top employers by the Top Employer Institute for consecutive years, a career at this company could be rich and rewarding experience for job seekers.

So what are you waiting for? Go ahead and apply now!</p>
  </div>
  <div class="col-md-6">
  <img src="vaya_images/hr_interview.png" alt="" class="img-fluid" id='recruitingimages'>
  </div>
</div>
     <!-- <div class="col-md-10">
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="vaya_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="vaya_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="vaya_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
