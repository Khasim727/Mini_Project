...
<html lang="en">
<head>
  <title> SMART ROTOMAC COMPANY</title>
  <link rel="icon"  href="smart_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="smart_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">MINI_PROJECT</a>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="1000">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <img src="smart_images/smart1.jpg" class="d-block  w-100" alt="Image 1">
          </div>
          <div class="carousel-item" data-bs-interval="1000">
            <img src="smart_images/smart2.jpg" class="d-block w-100" alt="Image 2">
          </div>
          <div class="carousel-item" data-bs-interval="1000">
            <img src="smart_images/smart3.jpg"class="d-block  w-100" alt="Image 3">
          </div>
        </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="para">SMART ROTAMACH PRIVATE LIMITED 83 followers on LinkedIn. Developing Smart Motive Solutions | We provide Engineering and Design services in the following .It is a Private company, incorporated on 11/08/2020. It is classified as a Non-govt company and registered at Hyderabad.Official registered address of the company is 6-2-92,3rd floor,khairatabad, hyderabad,telangana,india hyderabad hyderabad tg 500004 in.  </p> <br>

                <p class="para">SMART ROTAMACH PRIVATE LIMITED is a Private incorporated on 11 August 2020. It is classified as Non-govt company and is registered at Registrar of Companies.Established in 2017 , Smart Rotamac has gained immense expertise in offering Research Development Services etc. We are located in Hyderabad, Telangana  </p> <br>

                <p class="para">SMART ROTAMACH PRIVATE LIMITED Is Registered in Telangana state under ROC-HYDERABAD, And Registered Office is - 6-2-92,3rd floor,khairatabad, Hyderabad, ..Smart Rotamach Private Limited is an unlisted private company incorporated on 11 August, 2020. It is classified as a private limited company</p>
        </div>
...
<div class="row">
  <div class="col-md-10">
    <p class="para"> 
    For Hardware Design Engineer the minimum salary is ₹1.5 Lakhs per year, for Mechanical Design Engineer Trainee the minimum salary is ₹3.0 Lakhs per year and so on.<br>
      The Global headquarters for SMART ROTOMAC in SMART ROTAMACH PRIVATE LIMITED registered address is 6-2-92,3rd floor,khairatabad, Hyderabad,Telangana,India Hyderabad Hyderabad TG 500004 IN. It's Annual General Meeting (AGM) was last held on 30/09/2022.<br>
      The  SMART ROTOMAC recruitment process consists of THREE rounds of selection and includes:
...
<div class="col-md-6 text-align-center">
     <h3 align="center" id='headings'>1.GD topics&Talent Assessment Test</h3>
     ...
     <div class="col-md-6">
      ...
      <img src="smart_images/apptitude.png" alt="" class="img-fluid"  id='recruitingimages'>
     </div>
...
<div class="row mt-2">
  <div class="col-md-6">
    <img src="smart_images/interview.png" alt="" class='img-fluid'  id='recruitingimages'>
  </div>
  <div class="col-md-6">
...
<p class='para'>With smart rotomac being named one of the world’s top employers by the Top Employer Institute for consecutive years, a career at this company could be rich and rewarding experience for job seekers.

So what are you waiting for? Go ahead and apply now!</p>
  </div>
  <div class="col-md-6">
  <img src="smart_images/hr_interview.png" alt="" class="img-fluid" id='recruitingimages'>
  </div>
</div>
     <!-- <div class="col-md-10">
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="smart_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="smart_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="smart_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
