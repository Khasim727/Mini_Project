...
<html lang="en">
<head>
  <title>APCFSS Infosystems company</title>
  <link rel="icon"  href="apcfss_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="apcfss_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">MINI_PROJECT</a>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="1000">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <img src="apcfss_images/apcfss1.jpg" class="d-block  w-100" alt="Image 1">
          </div>
          <div class="carousel-item" data-bs-interval="1000">
            <img src="apcfss_images/apcfss2.jpg" class="d-block w-100" alt="Image 2">
          </div>
          <div class="carousel-item" data-bs-interval="1000">
            <img src="apcfss_images/apcfss3.jpg"class="d-block  w-100" alt="Image 3">
          </div>
        </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="para">APCFSS has developed and manages the Comprehensive Financial Management System (CFMS), a Government-wide enterprise suite, for the management of various aspects of Public Finances of the State of Andhra Pradesh.</p> <br>

                <p class="para">We provide career opportunities in the fields of IT, ITES, Consulting and Administration. APCFSS is continuously involved in building careers by hiring the best.Top Management. APCFSS consists of a Board Chaired by Sri S S Rawat, IAS The Board Currently Consists of Sri Dr.KVV Satyanarayana, IRAS, and Sri B Sunil Kumar Reddy, IFS as the CEO .</p> <br>

                <p class="para">APCFSS is known for Job Security which is rated at the top and given a rating of 3.2. However, Salary & Benefits is rated the lowest at 2.4 and can be improved.MD of apcfss company is Maheshwara Reddy, CEO, Society for Employment Generation, Enterprise Development in AP (SEEDAP) is placed in Full Additional Charge to the post of Executive Director, AP Corporation for Outsourced Services with immediate effect. 2.</p>
        </div>
...
<div class="row">
  <div class="col-md-10">
    <p class="para"> 
    The average APCFSS salary ranges from approximately ₹2.7 Lakhs per year for a Full Stack Developer to ₹10.6 Lakhs per year for a Team Lead.Average annual salary in APCFSS is INR 6.2 lakhs.For another role.<br>
      The Global headquarters for APCFSS  in ANDHRA PRADSH. company is one of the best places to work if you are looking for a career  <br>
      The  APCFSS recruitment process consists of THREE rounds of selection and includes:
...
<div class="col-md-6 text-align-center">
     ...
     <div class="col-md-6">
      ...
      <img src="apcfss_images/apptitude.png" alt="" class="img-fluid"  id='recruitingimages'>
     </div>
...
<div class="row mt-2">
  <div class="col-md-6">
    <img src="apcfss_images/interview.png" alt="" class='img-fluid'  id='recruitingimages'>
  </div>
  <div class="col-md-6">
...
<p class='para'>With APCFSS  being named one of the world’s top employers by the Top Employer Institute for consecutive years, a career at this company could be rich and rewarding experience for job seekers.

So what are you waiting for? Go ahead and apply now!</p>
  </div>
  <div class="col-md-6">
  <img src="apcfss_images/hr_interview.png" alt="" class="img-fluid" id='recruitingimages'>
  </div>
</div>
     <!-- <div class="col-md-10">
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="apcfss_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="apcfss_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="apcfss_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
