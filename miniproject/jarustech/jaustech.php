...
<html lang="en">
<head>
  <title>Jarustech company</title>
  <link rel="icon"  href="jaru_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="jaru_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">MINI_PROJECT</a>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="1000">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <img src="jaru_images/way3.jpg" class="d-block  w-100" alt="Image 1">
          </div>
          <div class="carousel-item" data-bs-interval="1000">
            <img src="jaru_images/way2.jpg" class="d-block w-100" alt="Image 2">
          </div>
          <div class="carousel-item" data-bs-interval="1000">
            <img src="jaru_images/way3.jpg"class="d-block  w-100" alt="Image 3">
          </div>
        </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="para">The Company is engaged in providing software development services that assists corporations automate business processes and develop flexible service oriented systems. Jarus Technologies (India) offers a wide range of products and services, including: IT, Networking & Automation Solution. IT Solutions.</p> <br>

                <p class="para">Jarus helps corporations automate business processes, improve efficiency and cut costs. Backed by a highly-skilled team with extensive domain and technology ....</p> <br>
                A feature rich, configurable portal for policyholders to view policy information, view id cards, make payments, get accident help, create first notice of loss, .
                <p class="para">Jarus Technologies is a small technology company based in Pittsburgh, PA with only 130 employees and an annual revenue of $6.7M. Be the first to review!The organizational chart highlights the reporting lines within the company, starting with Sundar Vallinayagam - the Chief Executive Officer of Jarus Technologies, and followed by additional decision makers: Bala Kumar, Co-Founder & Vice President, and more..</p>
        </div>
...
<div class="row">
  <div class="col-md-10">
    <p class="para"> 
    Jarus Technologies (India) Private Limited · Location. Hyderabad, Telangana, India · Website. jarustech.com · Telephone. lock · Email Address. lock · Social Media. <br>
      ...
      The JARUSTECH recruitment process consists of THREE rounds of selection and includes:
...
<div class="col-md-6 text-align-center">
     ...
     <p class="para">The WRITTEN TEST test consists of four sections and total time allotted is 120 minutes.</p>
     <p>It includes:</p>
     ...
     <div class="col-md-6">
      ...
      <img src="jaru_images/apptitude.png" alt="" class="img-fluid"  id='recruitingimages'>
     </div>
...
<div class="row mt-2">
  <div class="col-md-6">
    <img src="jaru_images/interview.png" alt="" class='img-fluid'  id='recruitingimages'>
  </div>
  <div class="col-md-6">
...
<p class='para'>With jarustech being named one of the world’s top employers by the Top Employer Institute for consecutive years, a career at this company could be rich and rewarding experience for job seekers.

So what are you waiting for? Go ahead and apply now!</p>
  </div>
  <div class="col-md-6">
  <img src="jaru_images/hr_interview.png" alt="" class="img-fluid" id='recruitingimages'>
  </div>
</div>
     <!-- <div class="col-md-10">
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="jaru_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="jaru_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="jaru_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
