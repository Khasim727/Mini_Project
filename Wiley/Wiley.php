...
<html lang="en">
<head>
  <title>Wiley Company</title>
  <link rel="icon"  href="Wiley_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="Wiley_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">MINI_PROJECT</a>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <img src="Wiley_images/Wiley1.jpg" class="d-block  w-100" alt="Image 1">
          </div>
          <div class="carousel-item" data-bs-interval="3000">
            <img src="Wiley_images/Wiley2.jpg" class="d-block w-100" alt="Image 2">
          </div>
          <div class="carousel-item" data-bs-interval="3000">
            <img src="Wiley_images/Wiley3.jpg"class="d-block  w-100" alt="Image 3">
          </div>
        </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="para">Wiley is a research and education company. It develops digital education, learning, assessment, and certification solutions. The company publishes online scientific, technical, medical, and scholarly journals, books and other digital content.</p>
           <p class="para">We are bridging the higher education gap by delivering content solutions in new and innovative ways to enrich the learning experience. We are a proven leader in strategic higher education consulting and partnering with educators and institutions globally to achieve success, and our print and digital solutions enable students and instructors worldwide. We encourage learning to be a continuous, lifelong experience – an integral, essential part of every stage of building a career.</P>
           <p class="para">Wiley is a global leader in research and education, unlocking human potential by enabling discovery, powering education, and shaping workforces. For over 200 years, Wiley has fueled the world's knowledge ecosystem.Brian Napack is President and Chief Executive Officer of Wiley, the 14th President since Wiley was founded in 1807. </P>
           </div>
...
<div class="row">
  <div class="col-md-10">
    <p class="para">
    The hiring process at Wiley takes an average of 9.5 days when considering 24 user submitted interviews across all job titles
    </p>
    <p class="para">Wiley Edge interview process usually has 3-4 rounds. The most common rounds in the Wiley Edge interview process are Resume Shortlist, Aptitude Test and Coding Test.
...
<div class="col-md-6"><BR><BR><BR><br>
      ...
      <img src="Wiley_images/apptitude.png" alt="" class="img-fluid"  id='recruitingimages'>
     </div>
...
<div class="col-md-6"><br><br><br><br><br>
    <img src="Wiley_images/interview.png" alt="" class='img-fluid'  id='recruitingimages'>
  </div>
</div>
...
<div class="col-md-6"><br><br><br><br><br><br>
  <img src="Wiley_images/hr_interview.png" alt="" class="img-fluid" id='recruitingimages'>
  </div>
  <div class="col-md-6">
    <br>
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="Wiley_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="Wiley_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="Wiley_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
