      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="2000">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item" data-bs-interval="1500">
            <img src="sankalp_images/sankalp.jpg" class="d-block w-100" alt="Image 2">
          </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="para" style="font-size:20px">Sankalp Semiconductor (An HCL Technologies Company) is a preferred semiconductor design service partner of top chip manufacturers, design foundries and OEMs across the globe.<br> Sankalp semi has 753 employees as of Mar 23. The total employee count is 89 lower than it was for Feb 23.<br> Average annual salary in Sankalp Semiconductor is INR 8.1 lakhs</p>
...
HR interview round: The HR interview round is the last round where candidates are judged on the basis of their communication skills, soft skills, confidence level, etc.<br>
      The sankalp semiconductor company recruitment process consists of three rounds of selection and includes:</p>
