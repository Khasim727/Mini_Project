...
<html lang="en">
<head>
  <title>TigerAnalytics Company</title>
  <link rel="icon"  href="TigerAnalytics_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="TigerAnalytics_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">MINI_PROJECT</a>
    ...
    <div class="col-md-12">
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
       ...
       <div class="carousel-item active">
        ...
        <img src="TigerAnalytics_images/TigerAnalytics1.jpg" class="d-block  w-100" alt="Image 1">
          </div>
          <div class="carousel-item" data-bs-interval="3000">
            <img src="TigerAnalytics_images/TigerAnalytics2.jpg" class="d-block w-100" alt="Image 2">
          </div>
          <div class="carousel-item" data-bs-interval="3000">
            <img src="TigerAnalytics_images/TigerAnalytics3.jpg"class="d-block  w-100" alt="Image 3">
          </div>
        </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="para">Tiger Analytics is pioneering what AI and analytics can do to solve some of the toughest problems faced by organizations globally. We develop bespoke solutions powered by data and technology for several Fortune 500 companies. We have offices in multiple cities across the US, UK, India, and Singapore, and a substantial remote global workforce. We have received multiple awards ranging from being recognized as a Leader by Forrester Research to being ranked among the fastest-growing tech companies by Inc. and Financial Times. We consistently feature in prestigious ‘Best Analytics Firms’ lists. 
</p>
           <p class="para">If you’re interested to explore career opportunities with Tiger, we’d love to tell you more. You’ll work alongside the best in the industry, learn the structured approach to innovate, and have fun along the way. Tiger Analytics India Consulting Private Limited's Annual General Meeting (AGM) was last held on N/A and as per records from Ministry of Corporate Affairs (MCA), its balance sheet was last filed on N/A.</P>

           <p class="para"> Directors of Tiger Analytics India Consulting Private Limited are Sri Ganesh Gopalaiyer and Pradeep Kumar Gulipalli.Current status of Tiger Analytics India Consulting Private Limited is - Active.Tiger Analytics is rated 3.6 out of 5, based on 294 reviews by employees on AmbitionBox. Tiger Analytics is known for Salary & Benefits which is rated at the top and given a rating of 3.7. However, Job Security is rated the lowest at 3.3 and can be improved.</P>
           </div>
    </div>
</div>
...
<div class="row">
 ...
 <p class="para">There are often numerous steps in the Tiger Analytics interview process, including a phone screening interview, a technical interview, and an in-person interview. There might also be further rounds of interviews in specific circumstances, such as a case study or a behavioural interview.Pre-screening of application 1st round- assessment 2nd round- Coding test 3rd round- Technical interview 4th round- HR discussion Interview process is very slow and they are not informing the update about the status of application.</p>
  <UL STYLE="FONT-SIZE:20PX"><li>Step 1- Aptitude </li><li>Step 2-Coding round </li>
...
<div class="col-md-6 text-align-center"><br><br>
     ...
     <div class="col-md-6"><BR><BR><BR><br>
      ...
      <img src="TigerAnalytics_images/apptitude.png" alt="" class="img-fluid"  id='recruitingimages'>
     </div>
...
<div class="row mt-2">
<div class="col-md-6"><br><br><br><br>
    <img src="TigerAnalytics_images/coding.jpg" alt="" class='img-fluid'  id='recruitingimages'>
    </div>
  <div class="col-md-6">
    <br>
  <h3 align="center" id='headings'>2.Coding Round</h3>
  <p class="para">In general, being able to do 100% of Easy and 75% of the Medium level questions will be sufficient for you to clear the coding rounds of the best companies. In order to complete this set of problems, it could take you from anywhere 1.5 to 3 months depending on your level of comfort with programming problems</p><br>
  <p class='para'>
...
Practice with mock interviews.</p>
...
<div class="col-md-6"><br><br><br><br><br>
    <img src="TigerAnalytics_images/interview.png" alt="" class='img-fluid'  id='recruitingimages'>
  </div>
</div>
...
<div class="col-md-6"><br><br><br><br><br><br>
  <img src="TigerAnalytics_images/hr_interview.png" alt="" class="img-fluid" id='recruitingimages'>
  </div>
  <div class="col-md-6">
    <br>
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="TigerAnalytics_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
...
<?php
    ...
    $PositiveScript = 'C:\xampp\new\htdocs\miniproject\khasim\python\tiger_pos.py'; //python file path
...
?>
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="TigerAnalytics_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
          <h4 class="card-title">Negative</h4>
          <p class="card-text">
          <?php
    $pythonPath = "C:\\Users\\91630\\AppData\\Local\\Programs\\Python\\Python311\\pythonw.exe"; //python interpreter
    $NegtiveScript = 'C:\xampp\new\htdocs\miniproject\khasim\python\tiger_neg.py'; //python file path
...
?>
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="TigerAnalytics_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
...
<?php
    $pythonPath = "C:\\Users\\91630\\AppData\\Local\\Programs\\Python\\Python311\\pythonw.exe"; //python interpreter
    $NeturalScript = 'C:\xampp\new\htdocs\miniproject\khasim\python\tiger_netural.py'; //python file path
