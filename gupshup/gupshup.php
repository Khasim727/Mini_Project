...
<head>
  ...
  <link rel="icon"  href="gupshup_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="gupshup_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">Mini_Project</a>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="2000">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <img src="gupshup_images/gupshup1.jpg" class="d-block  w-100" alt="Image 1">
          </div>
          <div class="carousel-item" data-bs-interval="1500">
            <img src="gupshup_images/gupshup2.jpg
            " class="d-block w-100" alt="Image 2">
          </div>
          <div class="carousel-item" data-bs-interval="1500">
            <img src="gupshup_images/gupshup3.jpg"class="d-block  w-100" alt="Image 3">
          </div>
        </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="para">Gupshup was founded in 2004 by Beerud Sheth as an SMS network in India and is headquartered in Cupertino, California. In 2006, Gupshup launched an SMS-based social network that grew to 70M users. Gupshup also developed a smart messaging app, Teamchat, which introduced patent-pending “smart” messages in 2014.</p>
            <p class="para">Beerud is the cofounder and CEO of Gupshup, the world's leading platform for cloud messaging and conversational experiences. It is used by over 30K+ developers and handles over 4.5 billion messages per month.</p>
          </div>
...
<div class="row">
  <div class="col-md-10">
    <p class="para"> 
    The hiring process at Gupshup takes an average of 7 days when considering 22 user submitted interviews across all job titles. Candidates applying for Internship had the quickest hiring process (on average 1 day), whereas Java Engineer roles had the slowest hiring process (on average 15 days).<br>
      The gupshup recruitment process consists of One-on-one Round, Resume Shortlist and HR. rounds of selection and includes:
...
<div class="row">
  <div class="col-md-6">
  <img src="gupshup_images/resume.jpg" alt="" class="img-fluid" id='recruitingimages'>
  </div>
  <div class="col-md-6">
...
<div class="row">
  ...
  <div class="col-md-6">
    <img src="gupshup_images/Interview.png" alt="" class='img-fluid' id='recruitingimages'>
  </div>
</div>

<div class="row">
  <div class="col-md-6">
  <img src="gupshup_images/hr_interview.png" alt="" class="img-fluid" id='recruitingimages'>
  </div>
  <div class="col-md-6">
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="gupshup_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="gupshup_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="gupshup_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
