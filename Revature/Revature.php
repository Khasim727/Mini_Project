...
<html lang="en">
<head>
  <title>Revature Company</title>
  <link rel="icon"  href="Revature_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="Revature_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">MINI_PROJECT</a>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <img src="Revature_images/Revature1.jpg" class="d-block  w-100" alt="Image 1">
          </div>
          <div class="carousel-item" data-bs-interval="3000">
            <img src="Revature_images/Revature2.jpg" class="d-block w-100" alt="Image 2">
          </div>
          <div class="carousel-item" data-bs-interval="3000">
            <img src="Revature_images/Revature3.jpg"class="d-block  w-100" alt="Image 3">
          </div>
        </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="para">Revature is a technology talent development company headquartered in Reston, Virginia, USA. Its business model involves hiring recent U.S. college graduates, training them in high demand software skills, and deploying them to work on information technology projects for Revature’s corporate and government clients.Unlike coding “boot camps” and most other forms of information technology training, Revature does not charge its students tuition, instead paying them a salary during their training and project work</p> 
            <p class="para">Revature was founded in 2003(under the name Multivision)as a traditional staffing agency, but experienced difficulty finding prospective employees with the technology skills employers sought. Around 2014, it became a talent development company with the aim of supplying those unmet needs.In its current form, the company’s clients have included Accenture plc,Capital One, the Financial Industry Regulatory Authority (FINRA),and REI Systems, Inc. According to the company, it has trained more than 7,000 software engineers and is, according to Bloomberg, the largest employer of emerging technology talent in the U.S</p>
           <p class="para">In April 2020, during the COVID-19 pandemic, Revature announced that it would “donate approximately 2,000 hours of instructor-led, virtual coding training to essential workers, their families and others who have been impacted by COVID-19.In September 2020, Revature announced the launch of a suite of new workforce reskilling services designed for companies seeking to retrain their existing employees.</p>
        </div>
...
<div class="row">
  <div class="col-md-10">
    <p class="para">Revature Associate Software Engineer salary in India ranges between ₹ 2.8 Lakhs to ₹ 6.1 Lakhs with an average annual salary of ₹ 4.4 Lakhs. Salary estimates are based on 11 Revature latest salaries received from various employees of Revature.</p>
    <p class="para">The hiring process at Revature takes an average of 19.28 days when considering 70 user submitted interviews across all job titles.
 </p><p class="para">The selection process for these roles will be conducted through online/offline mode in four steps:</p>
...
<div class="col-md-6"><BR><BR><BR><br>
      ...
      <img src="Revature_images/apptitude.png" alt="" class="img-fluid"  id='recruitingimages'>
     </div>
...
<div class="col-md-6"><br><br><br><br><br>
    <img src="Revature_images/interview.png" alt="" class='img-fluid'  id='recruitingimages'>
  </div>
</div>
...
<div class="col-md-6"><br><br><br><br><br><br>
  <img src="Revature_images/hr_interview.png" alt="" class="img-fluid" id='recruitingimages'>
  </div>
  <div class="col-md-6">
    <br>
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="Revature_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="Revature_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="Revature_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
