...
<html lang="en">
<head>
  <title>Sarvani Company</title>
  <link rel="icon"  href="Sarvani_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="Sarvani_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">MINI_PROJECT</a>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <img src="Sarvani_images/Sarvani1.jpg" class="d-block  w-100" alt="Image 1">
          </div>
          <div class="carousel-item" data-bs-interval="3000">
            <img src="Sarvani_images/Sarvani1.jpg" class="d-block w-100" alt="Image 2">
          </div>
          <div class="carousel-item" data-bs-interval="3000">
            <img src="Sarvani_images/Sarvani1.jpg"class="d-block  w-100" alt="Image 3">
          </div>
        </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="para">Sarvani Industries Private Limited is an unlisted private company incorporated on 30 June, 2020. It is classified as a private limited company and is located in Krishna, Andhra Pradesh. It's authorized share capital is INR 10.00 cr and the total paid-up capital is INR 9.75 cr.</p>
           <p class="para">Sarvani Industries Private Limited's operating revenues range is INR 100 cr - 500 cr for the financial year ending on 31 March, 2022. It's EBITDA has increased by 54.85 % over the previous year. At the same time, it's book networth has increased by 17.86 %. Other performance and liquidity ratios are available here.The current status of Sarvani Industries Private Limited is - Active.</p>
           <p class="para">The last reported AGM (Annual General Meeting) of Sarvani Industries Private Limited, per our records, was held on 30 September, 2022.Sarvani Industries Private Limited has six directors - Vijayalakshmi Peddireddy, Jayadeep Peddireddy, and others.The longest serving directors currently on board are Vijayalakshmi Peddireddy, Jayadeep Peddireddy, Priyanka Nagalla and Gopal Reddy Peddireddy who were appointed on 30 June, 2020. They have been on the board for 2 years and 12 months. The most recently appointed directors are Dumpa Venkata Krishna Reddy and Divya Peddireddy, who were appointed on 20 July, 2020.
...
<div class="row">
  <div class="col-md-10">
    <p class="para">
    Average annual salary in SARVANI TELECOM is INR 4.5 lakhs . Salary estimates are based on 20 SARVANI TELECOM
    </p>
    <p class="para">Average Trenser Technology Solutions Private Limited Software Engineer salary in India is ₹ 4.2 Lakhs for experience between 1 years to 3 years. Software Engineer salary at Trenser Technology Solutions Private Limited India ranges between ₹ 2.8 Lakhs to ₹ 7.0 Lakhs.
 </p><p class="para">The selection process for this company will be conducted through online/offline mode in four steps:</p>
...
<div class="col-md-6 text-align-center"><br><br>
     ...
     <div class="col-md-6"><BR><BR><BR><br>
      ...
      <img src="Sarvani_images/apptitude.png" alt="" class="img-fluid"  id='recruitingimages'>
     </div>
...
<div class="row mt-2">
<div class="col-md-6"><br><br><br><br>
    <img src="Sarvani_images/GROUP.jpeg" alt="" class='img-fluid'  id='recruitingimages'>
    </div>
  <div class="col-md-6">
    <br>
...
<div class="col-md-6"><br><br><br><br><br>
    <img src="Sarvani_images/interview.png" alt="" class='img-fluid'  id='recruitingimages'>
  </div>
</div>
...
<div class="col-md-6"><br><br><br><br><br><br>
  <img src="Sarvani_images/hr_interview.png" alt="" class="img-fluid" id='recruitingimages'>
  </div>
  <div class="col-md-6">
    <br>
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="Sarvani_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="Sarvani_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="Sarvani_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
