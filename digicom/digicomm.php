...
<head>
  ...
  <link rel="icon"  href="digicomm_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="digicomm_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">Mini_Project</a>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="2000">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <img src="digicomm_images/digicomm2.png" class="d-block  w-100" alt="Image 1">
          </div>
          <div class="carousel-item" data-bs-interval="1500">
            <img src="digicomm_images/digicomm.jpg" class="d-block w-100" alt="Image 2">
          </div>
          <div class="carousel-item" data-bs-interval="1500">
            <img src="digicomm_images/digicomm1.jpg"class="d-block  w-100" alt="Image 3">
          </div>
        </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="para">Awarded and recognized by many forums as “Premier service company of India”
Digicomm is a young semiconductor solutions provider. We accentuate Industry’s business by providing our skilled and professional, technical services to fasten SOC development life cycles.

Digicomm offers an exclusive combination of research and development consultancy, to Semiconductor Vendors.</p>
</div>
...
<div class="row">
  <div class="col-md-10">
    <p class="para"> 
    TO THE NEW interview process usually has 3-4 rounds. The most common rounds in the TO THE NEW interview process are Technical, Resume Shortlist and HR.<br>
      The AD recruitment process consists of three rounds of selection and includes:
...
<div class="row">
  <div class="col-md-6">
  <img src="digicomm_images/resume.jpg" alt="" class="img-fluid" id='recruitingimages'>
  </div>
  <div class="col-md-6">
...
<div class="row">
  ...
  <div class="col-md-6">
    <img src="digicomm_images/Interview.png" alt="" class='img-fluid' id='recruitingimages'>
  </div>
</div>

<div class="row">
  <div class="col-md-6">
  <img src="digicomm_images/hr_interview.png" alt="" class="img-fluid" id='recruitingimages'>
  </div>
  <div class="col-md-6">
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="digicomm_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="digicomm_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="digicomm_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
