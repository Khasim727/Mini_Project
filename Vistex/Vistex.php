...
<html lang="en">
<head>
  <title>Vistex Company</title>
  <link rel="icon"  href="Vistex_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="Vistex_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">MINI_PROJECT</a>
    ...
    <div class="col-md-12">
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
       ...
       <div class="carousel-item active">
        ...
        <img src="Vistex_images/Vistex1.jpg" class="d-block  w-100" alt="Image 1">
          </div>
          <div class="carousel-item" data-bs-interval="3000">
            <img src="Vistex_images/Vistex2.jpg" class="d-block w-100" alt="Image 2">
          </div>
          <div class="carousel-item" data-bs-interval="3000">
            <img src="Vistex_images/Vistex3.jpg"class="d-block  w-100" alt="Image 3">
          </div>
        </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
           ...
           <p class="para">
           Vistex Inc. develops and implements software solutions. The Company develops enterprise software solutions, product design, manufacturing and supply chain, and marketing services. Vistex implements its platform to the wholesale distribution, consumer and commercial products, pharmaceutical, industrial machinery, electronics, retail, media, and services sectors.In a world where the sheer volume of  incentive programs has become completely unmanageable, someone had to find a way to make  sure the numbers actually add up – so  you never leave money on the table.  And that's where we come in.
           </p>

           <p class="para">Vistex solutions helps businesses take control of their mission-critical processes, including their promotions, rebates, pricing, discounts, and other incentives. With so many programs across so many partner relationships, it can be impossible to see where all the money is going, let alone how much difference it’s actually making to revenue. With Vistex, business leaders can see the numbers, see what really works, and see what to do next – so they can make sure every dollar they spend really is driving more growth, not just more costs. 
           </P>
           <p class="para">Is Vistex a good company to work for? Vistex has an overall rating of 3.9 out of 5, based on over 321 reviews left anonymously by employees. 75% of employees would recommend working at Vistex to a friend and 82% have a positive outlook for the business. This rating has improved by 5% over the last 12 months.</p>
           </div>
    </div>
</div>
...
<div class="row">
  <div class="col-md-10">
    <p class="para"> The hiring process at Vistex takes an average of 15.46 days when considering 43 user submitted interviews across all job titles.</p>
 <p class="para">The interview process was really smooth and the technical team panel was skilled. Questions were ask from Core ABAP</p>
...
<div class="col-md-6"><BR><BR><BR><br>
      ...
      <img src="Vistex_images/apptitude.png" alt="" class="img-fluid"  id='recruitingimages'>
     </div>
...
<div class="col-md-6"><br><br><br><br><br>
    <img src="Vistex_images/interview.png" alt="" class='img-fluid'  id='recruitingimages'>
  </div>
</div>
...
<div class="col-md-6"><br><br><br><br><br><br>
  <img src="Vistex_images/hr_interview.png" alt="" class="img-fluid" id='recruitingimages'>
  </div>
  <div class="col-md-6">
    <br>
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="Vistex_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="Vistex_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="Vistex_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
