...
<html lang="en">
<head>
  <title>UdyogYantra Company</title>
  <link rel="icon"  href="UdyogYantra_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="UdyogYantra_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">MINI_PROJECT</a>
    ...
    <div class="col-md-12">
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
       ...
       <div class="carousel-item active">
        ...
        <img src="UdyogYantra_images/UdyogYantra1.jpg" class="d-block  w-100" alt="Image 1">
          </div>
          <div class="carousel-item" data-bs-interval="3000">
            <img src="UdyogYantra_images/UdyogYantra2.jpg" class="d-block w-100" alt="Image 2">
          </div>
          <div class="carousel-item" data-bs-interval="3000">
            <img src="UdyogYantra_images/UdyogYantra3.jpg"class="d-block  w-100" alt="Image 3">
          </div>
        </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="para"> UdyogYantra Technologies provides AI and IoT-based solutions for the manufacturing industry. The cloud-based solution enables machine manufacturers, system designers and process automation experts to remotely monitor the manufacturing and assembly processes.Udyogyantra Technologies Llp is a Limited Liability Partnership firm incorporated on 29 August 2019. It is registered at Registrar of Companies, Delhi. Its total obligation of contribution is Rs. 100,000.
</p>
           <p class="para">Designated Partners of Udyogyantra Technologies Llp are Ankur Jain and Neeraj Jain.Udyogyantra Technologies Llp's last financial year end date for which Statement of Accounts and Solvency were filed is N/A and as per records from Ministry of Corporate Affairs (MCA), date of last financial year end date for which Annual Return were filed is N/A.Current status of Udyogyantra Technologies Llp is - Converted to CMP and Dissolved.</P>

           <p class="para">The overall rating of UdyogYantra Technologies is 5.0, with Skill development being rated at the top and given a rating of 5.0. However, Skill development is rated the lowest at 5.0. To know first hand how is it like to work at UdyogYantra Technologies read detailed reviews by job profile, department and location in the reviews section..</P>
           </div>
    </div>
</div>
...
<div class="col-md-6 text-align-center"><br><br>
     ...
     <div class="col-md-6"><BR><BR><BR><br>
      ...
      <img src="UdyogYantra_images/apptitude.png" alt="" class="img-fluid"  id='recruitingimages'>
     </div>
...
<div class="row mt-2">
<div class="col-md-6"><br><br><br><br>
    <img src="UdyogYantra_images/coding.jpg" alt="" class='img-fluid'  id='recruitingimages'>
    </div>
  <div class="col-md-6">
    <br>
...
<div class="col-md-6"><br><br><br><br><br>
    <img src="UdyogYantra_images/interview.png" alt="" class='img-fluid'  id='recruitingimages'>
  </div>
</div>
...
<div class="col-md-6"><br><br><br><br><br><br>
  <img src="UdyogYantra_images/hr_interview.png" alt="" class="img-fluid" id='recruitingimages'>
  </div>
  <div class="col-md-6">
    <br>
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="UdyogYantra_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="UdyogYantra_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="UdyogYantra_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
