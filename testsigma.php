...
<head>
  ...
  <link rel="icon"  href="test sigma_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="test sigma_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">Mini_Project</a>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="2000">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <img src="test sigma_images/ts.jpeg" class="d-block  w-100" alt="Image 1">
          </div>
          
          <div class="carousel-item" data-bs-interval="2000">
            <img src="test sigma_images/test sigma2.jpg"class="d-block  w-100" alt="Image 3">
          </div>
        </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="para">A unified, fully customizable platform that works out of the box. Build end-to-end tests 5X faster for web, mobile apps, & APIs with English scripts that self-heal, enabling maintenance-free testing.</p>
            <p class="para"> Average annual salary in Testsigma is INR 17.3 lakhs . Salary estimates are based on 54 Testsigma latest salaries received from various employees of Testsigma.</p>
</div>
...
Experience: 11 - 13 yrs

</td>
      <td>₹11.5L/yr - ₹11.5L/yr <br>
</td>
    </tr>
    <tr>
      <td>

      Automation Test Engineer <br>

Experience:  3 yrs

</td>
      <td>₹6.0L/yr - ₹6.0L/yr <br>
</td>
    </tr>
    <tr>
      <td>
...
<div class="row">
  <div class="col-md-10">
    <p class="para"> 
    Average annual salary in Testsigma is INR 17.3 lakhs . Salary estimates are based on 54 Testsigma latest salaries received from various employees of Testsigma.<br>
      The test sigma recruitment process consists of three rounds of selection and includes:
...
<div class="col-md-6 text-align-center">
     ...
     <div class="col-md-6">
      ...
      <img src="test sigma_images/apptitude.png" alt="" class="img-fluid"  id='recruitingimages'>
     </div>
...
<div class="row mt-2">
  <div class="col-md-6">
    <img src="test sigma_images/interview.png" alt="" class='img-fluid'  id='recruitingimages'>
  </div>
  <div class="col-md-6">
...
Most candidates tend to think that the HR interview is easy, but remember that a bad HR interview could end your chances of getting the job even after passing all the previous obstacles (aptitude test, technical round, etc.). The key here is to remain polite and confident. Interviews can be long and dreary so don’t forget to wear a smile!</p>
  ...
  <div class="col-md-6">
    <img src="test sigma_images/hr_interview.png" alt="" class='img-fluid' id='recruitingimages'>
  </div>
</div>
     <!-- <div class="col-md-10">
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="test sigma_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
...
<?php
    ...
    $PositiveScript = 'C:\xampp\new\htdocs\miniproject\khasim\python\testsigma_pos.py'; //python file path
...
?>
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="test sigma_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
          <h4 class="card-title">Negative</h4>
          <p class="card-text">
          <?php
    $pythonPath = "C:\\Users\\91630\\AppData\\Local\\Programs\\Python\\Python311\\pythonw.exe"; //python interpreter
    $NegtiveScript = 'C:\xampp\new\htdocs\miniproject\khasim\python\testsigma_neg.py'; //python file path
...
?>
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="test sigma_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
          ...
          <p class="card-text">
            ...
            <?php
    $pythonPath = "C:\\Users\\91630\\AppData\\Local\\Programs\\Python\\Python311\\pythonw.exe"; //python interpreter
    $NeturalScript = 'C:\xampp\new\htdocs\miniproject\khasim\python\testsigma_netural.py'; //python file path
