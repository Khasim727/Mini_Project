...
<head>
  ...
  <link rel="icon"  href="core compete_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="core compete_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">Mini_Project</a>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="2000">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <img src="core compete_images/core compete1.jpg" class="d-block  w-100" alt="Image 1">
          </div>
          <div class="carousel-item" data-bs-interval="1500">
            <img src="core compete_images/core compete.jpg" class="d-block w-100" alt="Image 2">
          </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="para" style="font-size:20px">Core Compete accelerates cloud analytics and digital transformations. We deliver innovative cloud-based solutions and migrations of on-premise workloads to the cloud to deliver agility, TCO reductions, and operational resilience.</p>
...
<div class="row">
  <div class="col-md-10">
    ...
    A Core Competency is a knowledge, skill, or ability that contributes to the successful completion of a task on the job. All employees use multiple competencies to perform their job.<br>
      The core compete software recruitment process consists of three rounds of selection and includes:</p>
...
<div class="col-md-6 text-align-center">
     ...
     <div class="col-md-6">
      ...
      <img src="core compete_images/apptitude.png" alt="" class="img-fluid"  id='recruitingimages'>
     </div>
...
<div class="row mt-2">
  <div class="col-md-6">
    <img src="core compete_images/interview.png" alt="" class='img-fluid'  id='recruitingimages'>
  </div>
  <div class="col-md-6">
...
Most candidates tend to think that the HR interview is easy, but remember that a bad HR interview could end your chances of getting the job even after passing all the previous obstacles (aptitude test, technical round, etc.). The key here is to remain polite and confident. Interviews can be long and dreary so don’t forget to wear a smile!</p>
  ...
  <div class="col-md-6">
    <img src="core compete_images/hr_interview.png" alt="" class='img-fluid' id='recruitingimages'>
  </div>
</div>
     <!-- <div class="col-md-10">
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="core compete_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="core compete_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="core compete_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
