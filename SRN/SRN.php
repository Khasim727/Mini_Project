...
<html lang="en">
<head>
  <title>SRN Technologies and Services Company</title>
  <link rel="icon"  href="SRN_images/logo.png">
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><img src="SRN_images/logo.png" alt="rgukt" height="50px" width="50px" class="flip-icon">MINI_PROJECT</a>
    ...
    <div class="col-md-12">
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
       ...
       <div class="carousel-item active">
        ...
        <img src="SRN_images/SRN3.jpg" class="d-block  w-100" alt="Image 1">
          </div>
          <div class="carousel-item" data-bs-interval="3000">
            <img src="SRN_images/SRN2.jpg" class="d-block w-100" alt="Image 2">
          </div>
          <div class="carousel-item" data-bs-interval="3000">
            <img src="SRN_images/SRN3.jpg"class="d-block  w-100" alt="Image 3">
          </div>
        </div>
...
<div class="aboutus" id="aboutus">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="para">S R N Technologies Private Limited is a Private incorporated on 09 October 2007. It is classified as Non-govt company and is registered at Registrar of Companies, Chennai. Its authorized share capital is Rs. 200,000 and its paid up capital is Rs. 0. It is inolved in Data processing. [This includes the processing or tabulation of all types of data. Provision of such services on (i) an hourly or time -share basis, and (ii) management or operation of data processing facilities of others on a time sharing basis; on a fee or contract basis].S R N Technologies Private Limited's Annual General Meeting (AGM) was last held on N/A and as per records from Ministry of Corporate Affairs (MCA), its balance sheet was last filed on N/A.
</p>
           <p class="para">Directors of S R N Technologies Private Limited are Raaja Ganapathy Naarayanaswamy and Rajalakshmi Chalat Seshan.
           Current status of S R N Technologies Private Limited is - Strike Off.In India, SRN Infotech has office in Indore.100% of employees reported the working days at SRN Infotech as Monday to Saturday.</P>

           <p class="para">SRN Technology Services is committed to investing in people of diverse talents and backgrounds and driving them to a brighter future. Our work combines advice with action and integrity. Our consulting and training services include Microsoft Dynamics 365, Audit, ITGC, Microsoft Dynamics AX, Microsoft Dynamics NAV, Microsoft Dynamics CRM, and Microsoft Azure. </P>
           </div>
    </div>
</div>
...
<div class="row">
  <div class="col-md-10">
    <p class="para">
    Get detailed salary information for salaries of popular job profiles in SRN Infotech: Web Developer: ₹ 2,80,000 per year, Customer Service Executive: ₹ 3,50,000 per year and many more.</p>
    <p class="para">The SRN Selection Procedure consists of 4 rounds, starting with a written test followed by a GD and technical test and the HR round of interview.</p>
...
<div class="col-md-6 text-align-center"><br><br>
     ...
     <div class="col-md-6"><BR><BR><BR><br>
      ...
      <img src="SRN_images/apptitude.png" alt="" class="img-fluid"  id='recruitingimages'>
     </div>
...
<div class="row mt-2">
<div class="col-md-6"><br><br><br><br>
    <img src="SRN_images/GROUP.jpEg" alt="" class='img-fluid'  id='recruitingimages'>
    </div>
  <div class="col-md-6">
    <br>
...
<div class="col-md-6"><br><br><br><br><br>
    <img src="SRN_images/interview.png" alt="" class='img-fluid'  id='recruitingimages'>
  </div>
</div>
...
<div class="col-md-6"><br><br><br><br><br><br>
  <img src="SRN_images/hr_interview.png" alt="" class="img-fluid" id='recruitingimages'>
  </div>
  <div class="col-md-6">
    <br>
...
<div class="reviews" id="reviews">
  ...
  <div class="row">
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid h-25 w-100" src="SRN_images/p.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="SRN_images/n.jpeg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-4 king">
      <div class="card">
        <img class="card-img-top img-fluid" src="SRN_images/nu.jpeg" alt="Card image cap">
        <div class="card-body">
